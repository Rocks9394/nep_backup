...
<div class="container all-chaptr-cards mt-5">
   <div class="row">
      <div class="col-12">
         <a href="{{ route('fms.report') }}" class="back-button">
            <span class="arrow">
         ...
         <div class="mt-5">
            <div class="stu__report__area">
               ...
               <div class="stu__report mt-3">
				...
				@else
					<p>No data available for Report 1.</p>
				@endif
			...
			@if ($ReportDetail2->isNotEmpty())	  
				...
				@else
					<p>No data available for Report 2.</p>
				@endif	
				...
				@else
					<p>No data available for Report 3.</p>
				@endif
				...
				@else
					<p>No data available for Report 4.</p>
				@endif
