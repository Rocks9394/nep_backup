                ...
                <div class="row text-center justify-content-md-center mt-3 mt-lg-4">
                    <div class="col-12 col-md-12 col-lg-12">
                        <ul class="list-group mt-3">
                            <li>
                                <a href="{{ url('assessor-app-student-code')}}"><span>Illinois Circuit</span><i class="bi bi-arrow-right"></i></a>
                            </li>
                            <li>
                                <a href="#a"><span>40x10 Meter Shuttle Run</span><i class="bi bi-arrow-right"></i></a>
                            </li>
                            <li>
                                <a href="#a"><span>Test 3</span><i class="bi bi-arrow-right"></i></a>
                            </li>
                            <li>
                                <a href="#a"><span>Test 4</span><i class="bi bi-arrow-right"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
