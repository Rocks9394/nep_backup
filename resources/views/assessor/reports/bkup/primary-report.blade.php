...
<body>
    ...
    <table cellpadding="0" cellspacing="0"
        style="width: 21cm; border-collapse: collapse; margin-left: auto; margin-right: auto; font-family: Roboto Condensed, sans-serif; font-size: 12px; border: 0px; background-color: #fff; height:1104px;">
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="border-collapse: collapse;">
                            <div style="position: relative; background-color: #fff;">
                                ...
                                <img src="{{ asset('public/assets/reports/report-graphic.png')}}" alt=""
                                ...
                                <tr>
                                    <td style="background-color:#E60A00;">
                                        <div style="position:relative; width:198px;">
                                            <span style="position:absolute; top:-45px; background:#00A923; padding:10px; width:178px; z-indix:2; box-sizing: border-box; text-align:center; color:#fff; font-size:16px; text-transform: uppercase; font-weight:600;">For Junior</span>
                                        <img src="{{ asset('public/assets/reports/aa-bg.png')}}" alt=""
                                    ...
                                    <td style="vertical-align: top; width: 100%;">
                                        <table cellpadding="0" cellspacing="0" style="width: 90%; border: 0;">
                                            ...
                                            <tr>
                                                <td
                                                    style="padding: 1px 30px 5px 46px; font-size: 20px; background:#0A87CD; color:#fff; font-size: 24px; font-weight: 500; position:relative;">
    ...
    <!-- Page 2 -->
    <table border="0" cellpadding="0" cellspacing="0" style="page-break-before: always; width: 100%; height:1124px;">
                                ...
                                <tr>
                                    <td style="width:300px;">
                                        <div style="margin-left: 24px; margin-top: 30px;">
                                            <img src="{{ asset('public/assets/reports/default_school-logo.png')}}" alt="" style="height:50px;">
                                        </div>
                                    </td>
                                    <td rowspan="2"
                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="border-bottom: 3px solid #E60A00;">
                                        <div style="align-items: left; color: #fff; font-size: 18px; font-weight: 600; height: 36px;">
                                            <div style="float: left; padding: 2px 0px 2px 10px; display:inline-block; background: #E60A00; margin-top:4px;">
                                                        ...
                                                        <tr>
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr style="background-color:#FBCA01;">
                                                                        <td style="width: 20%; background-color:#0A87CD; padding: 1px 4px 2px 6px; border: 1px solid #0A87CD; color:#fff; text-align: center; font-weight: bold; line-height:14px;"
                                                                            rowspan="2">Current Term</td>
                                                                        <td
                                                                            style="width: 25%; padding: 1px 4px 2px 6px; border: 1px solid orange; color:#000; text-align: center; font-weight: bold;">
                                                                            Date</td>
                                                                        <td
                                                                            style="width: 28%; padding: 1px 4px 2px 6px; border: 1px solid orange; color:#000; text-align: center; font-weight: bold;">
                                                                            Performance</td>
                                                                        <td
                                                                            style="padding: 1px 4px 2px 6px; border: 1px solid orange; color:#000; font-weight: bold; text-align: center;">
                                                                            Level</td>
                                                                    </tr>

                                                                    <tr>
                                                                        <td
                                                                            style="padding: 1px 4px 2px 6px; font-weight: 500; color:#000; text-align: center; border: 1px solid orange;">
                                                                            10 Jun 2025</td>
                                                                        <td
                                                            ...
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0"
                                                                    style="width: 100%; border: 1px solid orange; font-size: 14px; border-collapse: collapse; color:#333;">
                                                                    <tr style="background-color: #FBCA01;">
                                                                        <td style="font-weight: 500; width: 20%; background-color:#0A87CD; padding: 1px 4px 2px 6px; border: 1px solid #0A87CD; color:#fff; text-align: center; line-height:14px;"
                                                                            rowspan="2">Previous Term</td>
                                                                        <td
                                                                            style="font-weight: 500; width: 25%; padding: 1px 4px 2px 6px; border: 1px solid orange; color:#000; text-align: center; font-weight: bold;">
                                                                            Date</td>
                                                                        <td
                                                                            style="font-weight: 500; width: 28%; padding: 1px 4px 2px 6px; border: 1px solid orange; color:#000; text-align: center; font-weight: bold;">
                                                                            Performance</td>
                                                                        <td
                                                                            style="font-weight: 500; padding: 1px 4px 2px 6px; border: 1px solid orange; color:#000; font-weight: bold; text-align: center;">
                                                                            Level</td>
                                                                    </tr>
                                            ...
                                            <tr>
                                                <td>
                                                    <table border="1" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="background-color: #00A923; padding: 1px 10px 3px 10px; padding: 5px 10px; color: #fff; text-align: center; width: 120px; font-weight: bold; border-top: 1px solid #00A923; border-left: 1px solid #00A923;">
                                                                Recommendation</td>
                                                            <td style="padding: 1px 10px 3px 10px; line-height:14px; font-size:13px;">
                                            ...
                                            <tr>
                                                <td>
                                                    <table border="1" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td style="background-color: #00A923; padding: 1px 10px 3px 10px; padding: 5px 10px; color: #fff; text-align: center; width: 120px; font-weight: bold; border-top: 1px solid #00A923; border-left: 1px solid #00A923;">
                                                                Recommendation</td>
                                                            <td style="padding: 1px 10px 3px 10px; line-height:14px; font-size:13px;">Sports Fit. Keep it up!</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                    ...
                                    <td>
                                        <table border="1" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr style="background-color: #000;">
                                                <td style="padding: 1px 10px 3px 10px; font-weight: bold; color:#fff; font-size: 16px; line-height:18px;"
                                                    colspan="8">Fitness Benchmarks for 8 year Boy</td>
                                            </tr>
                                            <tr
                                                style="font-weight: bold; background-color: #ccc; color: #000; text-align:left;">
                                                <td
                                                    style="padding: 1px 10px 3px 10px; border: 1px solid #000; width:40px;">
                                                </td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">
                                                    L1&nbsp;(Very&nbsp;Low)</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">
                                                    L2&nbsp;(Low)</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">
                                            ...
                                            <tr style="background-color: #eee; font-weight: 500; text-align:left;">
                                                ...
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&lt; 20
                                                    %ile</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&gt; 20
                                                    %ile</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&gt; 40
                                                    %ile</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&gt; 60
                                                    %ile</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&gt; 70
                                                    %ile</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&gt; 80
                                                    %ile</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&gt; 90
                                                    %ile</td>
                                            </tr>
                                            <tr>
                                                <td
                                                    style="padding: 1px 10px 3px 10px; font-weight: bold; color: #000; border: 1px solid #000;">
                                                    Plate Tapping</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&lt; 00
                                                    m 17 s 310 ms to 00 m 15 s 510 ms</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&lt;00 m
                                            ...
                                            <tr>
                                                <td
                                                    style="padding: 1px 10px 3px 10px; font-weight: bold; color: #000; border: 1px solid #000;">
                                                    Flamingo Balance</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&lt; 26
                                                    times to 18 times</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&lt; 18
                                                    times to 14 times</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&lt; 14
                                                    times to 10 times</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&lt; 10
                                                    times to 8 times</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&lt; 8
                                                    times to 7 times</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&lt; 7
                                                    times to 5 times</td>
                                                <td style="padding: 1px 10px 3px 10px; border: 1px solid #000;">&lt; 5
                                                    times</td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
                                            <tr>
                                                <td
                                                    style="padding: 3px 10px 4px 10px; color:#fff; background-color: #000; font-size: 16px; font-weight: 600;">
    ...
    <!-- Page 3 -->
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height:1124px;">
                                ...
                                <tr>
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0A87CD; font-size:12px; width:100%;">
                                                        <tr>
                                                            <td
                                                                style="padding: 2px 4px; font-weight: 500; text-align:center; border-right: 1px solid #0A87CD; border-bottom: 1px solid #0A87CD;">
                                                                1</td>
                                                            <td
                                                                style="padding: 2px 4px; font-weight: 500; color:#000; border-right: 1px solid #0A87CD; border-bottom: 1px solid #0A87CD;">
                                                                Emerging</td>
                                                            <td
                                                                style="padding: 2px 4px; text-align: left; border-right: 1px solid #0A87CD; border-bottom: 1px solid #0A87CD; color:#333;">
                                                        ...
                                                        <tr>
                                                             <td
                                                                style="padding: 2px 4px; font-weight: 500; text-align:center; border-right: 1px solid #0A87CD; border-bottom: 0px;">
                                                                3</td>
                                                            <td
                                                                style="padding: 2px 4px; font-weight: 500; color:#000; border-right: 1px solid #0A87CD; border-bottom: 0px;">
                                                                Acquired</td>
                                                            <td
                                                                style="padding: 2px 4px; text-align: left; border-right: 1px solid #0A87CD; border-bottom: 0px; color:#333;">
                                                             ...
                                                             <td
                                                                ...
                                                                4</td>
                                                            <td
                                                                style="padding: 2px 4px; font-weight: 500; color:#000; border-right: 1px solid #0A87CD; border-bottom: 0px; color:#333;">
                                                                Accomplished</td>
                                                            <td
                                                                style="padding: 2px 4px; text-align: left;">
                    ...
                    <tr>
                        <td style="height:234px; vertical-align:top;">
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td>
                                        <h4>Imbibing seven core values of Olympics and Paralympics</h4>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td style="text-align:left;">
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 80%; border: 0; border-collapse: collapse; margin: 0; border:1px solid #ccc;">
                                            <tr>
                                                <td style="width:50%; border-right:1px solid #ccc; text-align:center; overflow:hidden; height: 120px;">
                                                    <img src="{{ asset('public/assets/reports/3-olympic-value.png')}}" alt="" style="height: 118px; width:auto;">
                                                </td>
                                                <td style="width:50%; text-align:center; overflow:hidden; height: 120px;">
                                                    <img src="{{ asset('public/assets/reports/4-olympic-value.png')}}" alt="" style="height: 118px; width:auto;">
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #000; border-collapse: collapse; text-align:center; font-size:13px;">
                                            <tr style="background:#ccc; color:#000;">
                                                ...
                                                <th style="border:1px solid #000;">Sleep Time</th>
                                                <th style="border:1px solid #000;">Study Time</th>
                                                <th style="border:1px solid #000;">Play Time</th>
                                                <th style="border:1px solid #000;">Watch TV</th>
                                                <th style="border:1px solid #000;">Eating Time</th>
                                                <th style="border:1px solid #000;">School Time</th>
                                                <th style="border:1px solid #000;">Assignment</th>
                                            </tr>
                                            <tr>
                                                <td style="border:1px solid #000;">1-3</td>
                                                <td style="border:1px solid #000;">9 Hours</td>
                                                <td style="border:1px solid #000;">1 Hours</td>
                                                <td style="border:1px solid #000;">2 Hours</td>
                                                <td style="border:1px solid #000;">1 Hours</td>
                                                <td style="border:1px solid #000;">1 Hours</td>
                                                <td style="border:1px solid #000;">7 Hours</td>
                                                <td style="border:1px solid #000;">1 Hours</td>
                                            </tr>
                                            <tr>
                                                <td style="border:1px solid #000;">1-3</td>
                                        ...
                                        <div style="clear:both; margin-top:10px;">
                                            ...
                                            <ul style="margin-left:15px; margin-top:3px; line-height:12px; font-size:12px;">
                        ...
                        <td style="width: 100%; text-align: right;">
                            <table cellpadding="0" cellspacing="0" style="border: 0px; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div
                                            style="padding: 4px 0; text-align: right; font-weight: 400; font-size: 13px; color:#666;">
    ...
    <!-- Page 4 -->
    <table border="0" cellpadding="0" cellspacing="0" style="page-break-before: always; height:1124px;">
        <tr>
            <td>
                                        ...
                                        <table cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <p style="padding-left:14px; padding-right:14px;">Single-Leg Stance,
                                                            ...
                                                            <td>
                                                                <table cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            style="vertical-align: top; padding-right:10px;">
                                                                            <table class="act-tbl col-2" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #0A87CD; font-size: 12px; border-collapse: collapse; color:#333; width:100%;">
                                                                                <tr style="background-color: #0A87CD">
                                                                                    <td
                ...
                <table border="1" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding: 10px 15px; font-size: 14px; color: #000; height:100px; vertical-align:top;">
                            ...
                            <p style="padding-top:5px; font-size:13px;">Static Balance (Flamingo Balance Test), Hand Eye Coordination (Plate Tapping), Running, Hopping, Jumping & Landing	, One-Foot Balance, Beam Walk, Catching & Receiving Bounce Ball	, Dribbling With Hand, BMI (Body Mass Index)</p>
