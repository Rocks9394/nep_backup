...
<style>
    @media only screen and (max-width: 600px) {.btn {  min-width: 80px; } #laps_completed{  width: 100px;} }
    @media only screen and (min-width: 600px) {.btn { min-width: 170px; }  #laps_completed{ width: 140px;}}
    @media only screen and (min-width: 768px) {.btn {  min-width: 170px;} #laps_completed{ width: 140px; } }
...
<form class="row bg-white mt-4" method="POST" name="test_type_pacer" id="test_type_pacer_id" action="javascript:void(0);">
    {{ method_field('post') }}
    @csrf
