                        ...
                        <td style="border-collapse: collapse;">
                            <div style="position: relative; background-color: #fff;">
                                <div
                                    ...
                                    <img src="{{ public_path('assets/reports/green-dot.jpg') }}" alt=""
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <img src="{{ public_path('assets/reports/seqfast-logo.png') }}" alt=""
                                ...
                                <img src="{{ public_path('assets/reports/report-graphic.png') }}" alt=""
                                    style="position: absolute; top:26%; right:40px; width: 200px; border-collapse: collapse; z-index:9;">

                                <img src="{{ public_path('assets/reports/report-cover-j-img.jpg') }}" alt=""
                                    ...
                                    <td style="background-color:#E60A00;">
                                        <div style="position:relative;">
                                            <span
                                                ...
                                                Junior</span>
                                            <img src="{{ public_path('assets/reports/aa-bg.png') }}" alt=""
                                                style="width:198px;">
                                        </div>
                                    </td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 90%; border: 0;">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    @else
                                                        <img src="{{ public_path('assets/uploads/logos/default_school-logo.png') }}"
                                                            alt=""
                                                            style="padding: 0px 0px 5px 46px; height: 100px;">
                                                    @endif
                                                </td>
                                                ...
                                                <td
                                                    ...
                                                    Student Profile<span
                                                        style=" position:absolute; top:44px; right:-21px;"><img
                                                            src="{{ public_path('assets/reports/green-bg.jpg') }}"
                                                                ...
                                                                <table cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            ...
                                                                            {{ $studentsData->display_classname }}-{{ $studentsData->section }}
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            style="border-bottom: 1px solid #e5e5e5; width: 100%; text-align: center; font-weight: 600;">
                                                                            {{ $studentsData->admissionnumber }}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 100%; border:0;">
                                <tr>
                                    <td rowspan="2"
                                        ...
                                        <img src="{{ public_path('assets/reports/inner-header2-bg.png') }}"
                                            alt=""
                                                                ...
                                                                <tr>
                                                                    <td style="width: 50%;">
                                                                        <table border="1" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td style="padding: 0px 4px 2px 6px; font-weight: 500; color:#000; text-align: center; width:40%">{{ $value['Current_Term'][0]['created_at'] ?? '---'}}
                                                                                </td>
                                                ...
                                                <tr style="text-align:center;">
                                                    @if (is_array($getBmiBenchmark) && count($getBmiBenchmark) > 0)
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;">
                                                            {{ $getBmiBenchmark['UW'] ?? 'N/A' }}</td>
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;">
                                                            {{ $getBmiBenchmark['N'] ?? 'N/A' }}</td>
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;">
                                                            {{ $getBmiBenchmark['OW'] ?? 'N/A' }}</td>
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;">
                                                            {{ $getBmiBenchmark['OB'] ?? 'N/A' }}</td>
                                                    @endif
                                                </tr>
                                ...
                                <tr>
                                    <td style="vertical-align: top;">
                                        <table border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="padding: 1px 4px 2px 6px; font-weight: 500; color:#000; border: 1px solid orange;"> {{ $data['Test_Name'] ?? '' }}</td>
