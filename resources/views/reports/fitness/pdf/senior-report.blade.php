                    ...
                    <tr>
                        <td style="border-collapse: collapse;">
                            <div style="position: relative; background-color: #fff;">
                                ...
                                <img src="{{ public_path('assets/reports/report-cover-img.jpg')}}" alt="" style="width: 76%; z-index:2; position: relative; top:0;">
                            </div>
                                            ...
                                            <tr>
                                                <td>
                                                    @if(!empty($studentsData->logo)) 
                                                        <img src="{{ public_path('assets/uploads/logos/' . $studentsData->logo) }}" alt="" style="padding: 0px 0px 5px 46px; height: 100px;">
                                                    @else
                                                        <img src="{{ public_path('assets/uploads/logos/default_school-logo.png' )}}" alt="" style="padding: 0px 0px 5px 46px; height: 100px;">      
                                                    @endif
                                    ...
                                    <td style="width:300px;">
                                        @if(!empty($studentsData->logo))                                        
                                            <div style="position: absolute; top: 30px; left:22px; display: flex; align-items: center; z-index: 1;">
                                                <img src="{{ public_path('assets/uploads/logos/' . $studentsData->logo) }}" alt="" style="width: auto; height: 50px; object-fit: contain;">
                                            </div>
                                        @else
                                            <div style="position: absolute; top: 30px; left:22px; display: flex; align-items: center; z-index: 1;">
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0; border-collapse: collapse; border:1px solid #F28F0C; font-size: 12px; text-align:left; line-height:12px;">
                                            ...
                                            <tr>
                                                <!-- <td style="vertical-align: top; padding: 3px 4px; border:1px solid #0A87CD;">
                                                    <img src="{{ asset('assets/reports/checked.png')}}" alt="checked" height="12px">
                                                </td> -->
                                                <td style="vertical-align: top; padding: 3px 4px; border:1px solid #0A87CD;">
                                    ...
                                    <td>
                                        <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #0A87CD; font-size: 12px; border-collapse: collapse; color:#000;">
                                            <tr style="background-color: #0A87CD;">
                                                <td style="padding: 5px 10px; font-weight: bold; color:#fff; font-size: 14px;" colspan="8">Fitness Benchmarks for {{ $age }} years {{ $gender }}</td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="8" style="padding: 4px; border:1px solid #0A87CD;">
                                                    <p style="text-align:center;">
                                                        ...
                                                        No Fitness Benchmarks available for a {{ $age }}-year-old {{ $gender }} in {{ $studentsData->class }}
                                                    </p>
                                                </td>
                                            </tr>
                                            @endforelse                               
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="text-align:center;">
                                                    @if(is_array($getBmiBenchmark) && count($getBmiBenchmark) > 0)
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;">{{ $getBmiBenchmark['UW'] ?? 'N/A' }}</td>
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;">{{ $getBmiBenchmark['N'] ?? 'N/A' }}</td>
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;">{{ $getBmiBenchmark['OW'] ?? 'N/A' }}</td>
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;">{{ $getBmiBenchmark['OB'] ?? 'N/A' }}</td>
                                                    @endif
                                                </tr>
