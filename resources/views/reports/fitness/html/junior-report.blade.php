                                                            ...
                                                            <td colspan="2" style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px;">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;"> {{ $studentsData->display_classname }}-{{ $studentsData->section }}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;">{{ $studentsData->rollno ?? ''}} </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            <td style="padding: 6px 0; width:55%;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;">{{ $studentsData->admissionnumber }}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;">{{ $formattedDob }} ({{ $age }} Years)</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;">{{ $gender }}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td colspan="2" style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;">{{ $studentsData->school_name }}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;">{{ $studentsData->school_code }}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: left; font-weight: 600; padding: 0px 0px 4px 0px;">{{ $studentsData->apaarId ?? ''}}</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" style="width: 94%; border: 0; border-collapse: collapse; margin: auto;">
                                ...
                                <tr>
                                    <td style="padding: 6px 10px 6px 0px; font-size: 18px; color:#000; font-size: 16px; font-weight: 600;">{{ $displayKey }}</td>
                                </tr>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; border-bottom: 1px solid #00A923; font-size: 14px; border-collapse: collapse; color:#333;">
                                                                    ...
                                                                    <tr>                
                                                                        ...
                                                                        <td style="padding: 4px 4px 4px 6px; text-align: center;">{{ $currentScore ?? '---'}}</td>
                                                                        <td style="padding: 4px 4px 4px 6px; text-align: center;">{{ $currentLevel ?? '---'}}</td>
                                                            ...
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; border-bottom: 1px solid #00A923; font-size: 14px; border-collapse: collapse; color:#333;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding: 4px 4px 4px 6px; font-weight: 500; color:#000; text-align: center;">{{ $value['Previous_Term'][0]['created_at'] ?? '---'}}</td>
                                                                        <td style="padding: 4px 4px 4px 6px; text-align: center;">{{ $previousScore ?? '---'}}</td>
                                                                        <td style="padding: 4px 4px 4px 6px; text-align: center;">{{ $previousLevel ?? '---'}}</td>
                                                ...
                                                <td>
                                                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border-top: 1px solid transparent; border-left: 1px solid #00A923; border-right: 1px solid #00A923; border-bottom: 1px solid #00A923; font-size: 14px; border-collapse: collapse; color:#333;">
                                                        <tr>
                                                            ...
                                                            <td style="padding: 3px 4px;">{{ $value['Current_Term'][0]['recommendation'] ?? '---' }}</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                    ...
                                    <td>
                                        <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #0A87CD; font-size: 14px; border-collapse: collapse; color:#000; text-align:center;">
                                            <tr style="background-color: #0A87CD;">
                                                <td style="padding: 5px 10px; font-weight: bold; color:#fff; font-size: 16px;" colspan="8">Fitness Benchmarks for {{ $age }} years {{ $gender }}</td>
                                            </tr>
                                            ...
                                            @foreach($getFitnessBenchmark as $key => $skillname)
                                            <tr>
                                                <td style="padding: 3px 4px; font-weight: bold; color: #000; text-align:left;">{{ $skillname->skill_name }}</td>
                                                @foreach($skillname->ranges as $level => $range)
                                                    <td style="padding: 3px 4px;">{{ $range}}</td>  
                                                @endforeach
                                            </tr>
                                            @endforeach
                                        </table>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0" style="width: 94%; border: 0; border-collapse: collapse; margin: auto;">
                                <tr>
                                    <td style="border-bottom: 3px solid #E60A00;">
                                        <div style="background:#E60A00; float:left; display: inline-flex; align-items: center; color: #fff; font-size: 18px; font-weight: 600; height: 32px;">
                                            <div style="float: left; padding: 1px 0px 0px 10px; margin-bottom: -3px;">Developmental Skills for {{ $studentsData->class }}-{{ $studentsData->section }}</div>
                                            <div style="float:left; transform: skew(26deg,0deg); display:inline-block; width: 20px; height: 32px; background: #E60A00; position: relative; right: -10px;"></div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 5px 10px; font-size: 20px; background:#0A87CD; color:#fff; font-size: 16px; font-weight: 600;">{{ $key }}</td>
                                </tr>
                                            ...
                                            <tr>
                                                <td style="vertical-align: top;">
                                                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; font-size: 13px; border-collapse: collapse; color:#333;">
                                                        ...
                                                        <tr>
                                                            <td style="padding: 3px 4px 3px 6px; font-weight: 500; color:#000;">{{ $data['Test_Name'] ?? '' }}</td>
                                                            ...
                                                            <td style="padding: 3px 4px 3px 6px; font-size: 12px;">{{ $data['recommendation'] ?? '' }}</td>
                                ...
                                <tr>
                                    <td style="padding: 5px 10px; font-size: 20px; background:#0A87CD; color:#fff; font-size: 16px; font-weight: 600;">Developmental Stages for {{ $age }} Years {{ $gender }}</td>
                                </tr>
                                ...
                                <tr>
                                    <td style="vertical-align:top;">                                      
                                        ...
                                        @switch($studentsData->class_id)
                                            @case(18)
                                                @include('assessor.reports.templates.posture')
                                                @break
                                            @case(14)
                                                @include('assessor.reports.templates.olympics-paralympics')
                                                @break
                                            @case(22)
                                                @include('assessor.reports.templates.daily-routine-table')
                                                @break
                                        @endswitch                                        
                                    </td>
                                </tr>                              
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; font-size: 14px; border-collapse: collapse; color:#000;">
                                            <tr>
                                                ...
                                                {{-- <td style="border: 1px solid transparent; width:50%;">
                                                    <div style="padding: 15px; height: 35px; margin: 10px 0; background-color: #fff; border-left: 3px solid #fff;"></div>
                                                    <p style="text-align: center; font-weight: 600;">Signature of Principal with Stamp</p>
                                                </td> --}}
                                            </tr>
                                        </table>
