                                            ...
                                            <div class="list d-flex justify-content-center">
                                                <div class="card media-card" data-media-type="image" onclick="openCardMedia(this)">
                                                    ...
                                                    <div class="card-body text-left">
                                                        <h5 class="card-title">
                                                            {{ $group->first()->activity ? $group->first()->activity->title : 'Activity' }}
                                                        </h5>

                                                        <div class="card-text d-flex justify-content-between flex-wrap">
                                                            <span>Date: {{ optional($group->first()->date)->format('d M Y') ?? 'N/A' }}</span>
                                                            <span>Class: {{ $group->first()->class_id ?? 'N/A' }}</span>
                                                        </div>
                                                    </div>

                                                    <div class="group-media d-none">
                                                        @foreach($group as $item)
                                                            <img data-type="image" data-src="{{ $item->url }}" data-date="{{ optional($item->date)->format('d M Y') ?? 'N/A' }}" />
                                                        @endforeach
                                                    </div>
                                        ...
                                        <div class="media-row gallery">
                                            ...
                                            <div class="list">
                                                <div class="card p-0 media-card" data-media-type="video" onclick="openCardMedia(this)">
                                                    ...
                                                    <div class="card-body text-left">
                                                        <h5 class="card-title">{{ $group->first()->activity ? $group->first()->activity->title : 'Activity Video' }}</h5>
                                                    ...
                                                    <div class="group-media d-none">
                                                        @foreach($group as $item)
                                                        <div data-type="video" data-src="{{ $item->url }}" data-date="{{ optional($item->date)->format('d M Y') ?? 'N/A' }}"></div>
                                                        @endforeach
                                                    </div>
                                                </div>
                                            </div>
        ...
        <div class="uploadfiels drop_box">
            ...
            <div class="upload d-flex flex-column w-100">
                ...
                <p class="info mt-3">
                    ...
                    </span>Selected files: <span id="selectedFileCount">0</span> / 4 (max 1MB for image and 20MB for videos each)
                </p>
            </div>
        </div>
