...
<div class="container">
	<div class="t-mrg">	
        ...
        <div class="row">
            <div class="col-12">               
				<h5 class="card-title text-center mb-0">Update Profile</h5> 
					...
					<form id="updateProfileForm">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								...
								<input type="date" class="form-control @error('dob') is-invalid @enderror" 
										id="dob" name="dob" value="{{$result->dob}}">
								@error('name')
									<div class="invalid-feedback">{{ $message }}</div>
								@enderror	
							</div>
						...
						<div class="form-row">
							<div class="form-group col-md-4">
								...
								<input type="email" class="form-control @error('email') is-invalid @enderror"  id="email" name="email" value="{{ old('email') ?? $result->email ?? '' }}">
						...
						<div class="form-row">
							...
							<div class="form-group col-md-3">
								...
								<input type="text" class="form-control @error('pincode') is-invalid @enderror"  id="pincode" name="pincode">
								@error('pincode') 
									<div class="invalid-feedback">{{ $message }}</div> 
								@enderror
							</div>
