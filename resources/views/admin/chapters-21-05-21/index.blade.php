						...
						<tbody>
							...
							<tr>
								...
								<td>
								  ...
								  <a class="btn btn-info btn-xs edit-btn" title="Update" href="{{ route('admin.chapters.edit', $cls->id) }}"> <i class="fas fa-pencil-alt"></i></a>
								   <form action="{{ route('admin.chapters.destroy', $cls->id) }}" method="POST">
										  @csrf
										  @method('DELETE')
