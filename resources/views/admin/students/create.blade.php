...
@section('title', 'Create Student - Goforfit')
              ...
              <form method="POST" action="{{ route('admin.students.store') }}" enctype='multipart/form-data'>
					...
					<div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Your Name') }}</label>
                                ...
                                <input id="name" type="text" placeholder="student name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
				...
				<div class="col-md-6">	
				 ...
				 <div class="form-group row">
                            <label for="gaurdian" class="col-md-4 col-form-label text-md-right">{{ __('Father/Mother') }}</label>

                            
                                <input id="gaurdian" type="text" placeholder="gaurdian" class="form-control @error('gaurdian') is-invalid @enderror" name="gaurdian" value="{{ old('gaurdian') }}" required autocomplete="city">
				 ...
				 <div class="form-group row">
                            <label for="gaurdian" class="col-md-4 col-form-label text-md-right">{{ __('Image') }}</label>

                            
                                <input id="file" type="file" placeholder="image" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}" required autocomplete="image">
                ...
                <div style="clear:both"></div> 
				 <div class="form-group row">
                            <label for="city" class="col-md-4 col-form-label text-md-right">{{ __('Address') }}</label>
                                ...
                                <input id="address" type="text" placeholder="address" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}" required autocomplete="city">
