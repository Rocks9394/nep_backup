                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="act-filter-bar">
                            <span class="ftr-academy flt-txt <?php if (!empty($_REQUEST['filterby'])) {
                                if ($_REQUEST['filterby'] == 'academy') {
                                    echo 'active';
                                }
                            } else {
                                echo 'active';
                            } ?> " id="btn-academy"
                                onclick="getfilter('academy')">For Academy</span>
                            <span class="ftr-sports flt-txt <?php if (!empty($_REQUEST['filterby']) && $_REQUEST['filterby'] == 'sports') {
                                echo 'active';
                            } ?>" id="btn-sports"
                                onclick="getfilter('sports')">For Sports</span>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <form class="form-inline fltr-row " type="get"
                                            ...
                                            if (!empty($subjects)) {
                                                foreach ($subjects as $cls) {
                                                    ...
                                                    if (!empty($_GET['subject'])) {
                                                        if ($cls->id == $_GET['subject']) {
                                                            $asubjects .= ' selected';
                                                            $asubjectname = $cls->name;
                                                        }
                                                    }
                                            ...
                                            if (!empty($skillareas)) {
                                                foreach ($skillareas as $skillarea) {
                                                    ...
                                                    if (!empty($_GET['skillarea'])) {
                                                        if ($skillarea->id == $_GET['skillarea']) {
                                                            $askillarea .= ' selected';
                                                            $askillareaname = $skillarea->name;
                                                        }
                                                    }
                                            ...
                                            if (!empty($sportskills)) {
                                                foreach ($sportskills as $sportskill) {
                                                    ...
                                                    if (!empty($_GET['skillsports'])) {
                                                        if ($sportskill->id == $_GET['skillsports']) {
                                                            $asportskills .= ' selected';
                                                            $asportskillname = $sportskill->name;
                                                        }
                                                    }
                                            ...
                                            if (!empty($techniques)) {
                                                foreach ($techniques as $technique) {
                                                    ...
                                                    if (!empty($_GET['technique'])) {
                                                        if ($technique->id == $_GET['technique']) {
                                                            $atechniques .= ' selected';
                                                            $atechniquename = $technique->name;
                                                        }
                                                    }
                                            ...
                                            <div class="fltr-drdwn form-group" id="fltr-academy" <?php if (!empty($_REQUEST['filterby']) && $_REQUEST['filterby'] == 'sports') {
                                                echo 'style="display:none"';
                                            } ?>>


                                                <select class="form-control selctopt" name="aclass" id="id_class0"
                                                    onchange="getsubjects(0,this.value)" style="width:125px">
                                                    <?= $aclasses ?>
                                                </select>


                                                <select class="form-control selctopt" id="id_subject0" name="subject"
                                                    onchange="getchapters(0,this.value)" style="width:138px">
                                                    <?= $asubjects ?>
                                                </select>



                                                <select class="form-control selctopt" id="id_chapter0" name="chapter"
                                                    onchange="getconcepts(0,this.value)" style="width:140px">
                                                ...
                                                <select class="form-control selctopt" name="concept" id="id_concept0"
                                                    name="concept" style="width:145px">
                                                ...
                                                <button type="submit" name="searchdata" value="searchdata"
                                                    class="btn btn-primary btn-sm"> <i class="fa fa-filter"
                                                        aria-hidden="true"></i></button>
                                            </div>



                                            <div class="fltr-drdwn form-group" id="fltr-sports" <?php if (empty($_REQUEST['filterby'])) {
                                                echo 'style="display:none"';
                                            } ?>
                                                <?php if (!empty($_REQUEST['filterby']) && $_REQUEST['filterby'] == 'academy') {
                                                    echo 'style="display:none"';
                                                } ?>>
                                                ...
                                                <select class="form-control selctopt" id="skillsports0" name="skillsports"
                                                    onchange="gettechnique(0,this.value)" style="width:145px">
                                                    <?= $asportskills ?>
                                                </select>
                                            ...
                                            <?php if (!empty($_GET['activity_name'])) {
                                                $tname = $_GET['activity_name'];
                                            } else {
                                                $tname = '';
                                            } ?>

                                            <div class="fltr-srch form-group">
                                                <input type="search" name="actname" value="<?= $tname ?>"
                                                    id="activity_name" class="form-control  fltr-txt-bx"
                                                    placeholder="Search Activity" width="180px">
                                        ...
                                        <div class="fltr-keys">
                                            ...
                                            if (!empty($_GET['actname'])) {
                                            ...
                                            } elseif (!empty($_GET['filterby']) && $_GET['filterby'] == 'academy') {
                                                $filtervar = '';
                                                $filtervar .= 'Filter by:';
                                                $filtervar .= '<ul>';
                                                if (!empty($aclsname)) {
                                                ...
                                                echo $filtervar;
                                            } elseif (!empty($_GET['filterby']) && $_GET['filterby'] == 'sports') {
                                                $filtervar = '';
                                                $filtervar .= 'Filter by: ';
                                                $filtervar .= '<ul>';
                                                if (!empty($sclsname)) {
