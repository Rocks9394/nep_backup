			...
			<div class="row">
				<div class="col-md-2">
					<h1 class="act-header">Activity</h1>					
					 <a href="{{ route('admin.activities.create') }}" class="create-btn"> <input type="submit" value="Add" class="btn btn-sm btn-success "></a>
				</div>
				<div class="col-md-10">
	...
	<div class="row">
      ...
      <div class="card">        
		<div class="card-header filter-head">  
		  <div class="row"> 
			<div class="col-md-12">
				<form class="form-inline fltr-row " type="get" action="{{ route('admin.activities.index') }}">				
		...
		<div class="row"> 
			<div class="col-12 div-count">
				<div class="fltr-count">Activities Found: <span class="no-counts">{{ $count }}<span></div>
			</div>
        </div>		      
            ...
            <?php if(!empty($posts)){
			 ...
			 ?>
			  ...
			  <tr> 
					...
					@if(Auth::user()->role_id == '1' OR Auth::user()->role_id == '4')					
				    <td>
					  <a class="btn btn-info btn-xs copy-btn pull-left" alt="Copy" title="Copy" href="{{ url('copy/'.$val->id)}}"> <i class="fa fa-copy"></i></a>
					  <a class="btn btn-info btn-xs edit-btn pull-left" title="Update" href="{{ route('admin.activities.edit',$val->id) }}"> <i class="fa fa-pencil-alt"></i></a>
					  <?php /* 
