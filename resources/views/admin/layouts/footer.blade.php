...
<script>
    ...
    console.log(selectedValues);
		...
		jQuery.ajax({
			url: "{{ route('check_clone_data') }}",
			data: {  "rowId" : rowId, 'selectedValues':selectedValues,  "_token" : "{{ csrf_token() }}"} ,
			type: "GET",
	...
	val = parseInt(val);
	jQuery.ajax({
		url: "{{ route('get_skillarea') }}",
		data: {  "class_id" : val, "_token" : "{{ csrf_token() }}"} ,
		type: "GET",
		success: function(response) {
	...
	jQuery.ajax({
		url: "{{ route('get_skillsports') }}",
		data: { "skillarea_id" : val, "class_id" : class_id, "_token" : "{{ csrf_token() }}"} ,
		type: "GET",
		success: function(response) {
			console.log(response);
	...
	function gettechnique(i, val){
		...
		//console.log(i, val);
		 ...
		 jQuery.ajax({
			url : "{{ route('get_technique') }}",
			data: { "sports_id" : val,  "skillarea_id": skillarea_id,  "class_id":class_id, "_token" : "{{ csrf_token() }}"} ,
			type: 'GET',
			success: function(response) {
...
<script>
	...
	function getchapters(i, val){
		...
		jQuery.ajax({
					...
					data: { "subject_id" : val, "class_id" : class_id, "_token": "{{ csrf_token() }}"} ,
					type: 'GET',
					success: function(response){
					  //console.log(response);
	...
	function getconcepts(i, val){
		...
		//console.log(i, val);
		jQuery.ajax({
					url: "{{ route('get_concepts') }}", 
					data: {  "subject_id" : subject_id, "class_id" : class_id, "chapter_id" : val, "_token": "{{ csrf_token() }}"} ,
					type: 'GET',
					success: function(response){
					 // console.log(response);
