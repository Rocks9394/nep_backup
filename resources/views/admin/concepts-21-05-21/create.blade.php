				...
				<form method="POST" action="{{ route('admin.concepts.store') }}" enctype="multipart/form-data">
					...
					<div class="card-body">
					   ...
					   @endif		
						...
						<div class="callout add-concepts" id="add-concepts-div">
						<div class="row">          
							<div class="col-md-12"> 
								<div class="form-group">
									<label>Concept*</label>
									<input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Concept" value="{{ old('name') }}">
								</div>
							</div>
						</div>
						...
						<div class="row">          
							...
							<div class="form-group">							
								...
								<textarea id="learning_outcomes" class="form-control mytextarea @error('learning_outcomes') is-invalid @enderror" name="learning_outcomes" placeholder="Enter Learning Outcomes">{{ old('learning_outcomes') }}</textarea>
								</div>
							</div>
						</div>
						...
						<div class="row">          
							...
							<div class="form-group">							
								...
								<textarea id="description" class="form-control mytextarea @error('description') is-invalid @enderror" name="description" placeholder="Description">{{ old('description') }}</textarea>
							</div>
							</div>
						</div>
