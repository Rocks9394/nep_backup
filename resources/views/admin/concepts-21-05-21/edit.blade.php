		...
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-12">
					...
					<h1 scope="col">Update Concept</h1>
				</div>
			</div>  
 		</div>
    </section>
					   ...
					   @endif		
						...
						<div class="row">          
							...
							<div class="form-group">							
								...
								<textarea id="learning_outcomes" class="form-control mytextarea @error('learning_outcomes') is-invalid @enderror" name="learning_outcomes" placeholder="Enter Learning Outcomes">{{ $concepts->learning_outcomes }}</textarea>
								</div>
							</div>
						</div>
						...
						<div class="row">          
							...
							<div class="form-group">							
								...
								<textarea id="description" class="form-control mytextarea @error('description') is-invalid @enderror" name="description" placeholder="Description">{{ $concepts->description }}</textarea>
							</div>
							</div>
						</div>
