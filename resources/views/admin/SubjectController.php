...
class SubjectController extends Controller {
    ...
    {
        $request->validate([ 'name' => 'required|regex:/^[a-zA-Z ]+$/u|unique:subject' ], ['name.required' => 'Subject cannot be empty', 'name.regex' => 'Subject can have alphabets only', 'name.unique' => 'Subject with this name already exist' ]); 
    ...
    {     
		$request->validate([ 'name' => 'required|regex:/^[a-zA-Z ]+$/u' ], ['name.required' => 'Subject cannot be empty', 'name.regex' => 'Subject can have alphabets only' ]); 
		...
		return redirect()->back()->with('success','Subjects has been updated successfully.');		
