...
@section('title', 'Goforfit - Subject list')
@section('content')
<div class="content-wrapper" id="subject-main"> 
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-2">
					<h1 class="act-header">Subjects</h1>					
					 <a href="{{ route('admin.subjects.create') }}" class="create-btn"> <input type="submit" value="Add" class="btn btn-sm btn-success "></a>
				</div>
			</div>
		</div>
    </section>
			...
			<div class="card">
				...
				<div class="card-header filter-head">  
					<div class="row"> 
						<div class="col-md-12">
							...
							<form class="form-inline fltr-row " type="get" action="{{ route('admin.subjects.index') }}">				
								...
								<div class="fltr-drdwn form-group" >
									<select class="form-control selctopt clsopt @error('aclass') is-invalid @enderror" name="aclass" id="id_class0" >
										<?=$aclasses?>
									</select>
							   ...
							   <?php if(!empty($_GET['name'])){ $name = $_GET['name'];}else{ $name='';  } ?> 
								...
								<div class="fltr-srch form-group">                	 
										<input type="search" name="name" value="<?=$name?>" id="name" class="form-control  fltr-txt-bx @error('name') is-invalid @enderror"  placeholder="Search Subject" width="180px">
				...
				<div class="row"> 
					<div class="col-12 div-count">
						<div class="fltr-count">Subjects Found: <span class="no-counts">{{ $count }}<span></div>
					</div>
				</div>
						...
						<tbody>
							...
							<tr>
								...
								<td>
								  ...
								  <a class="btn btn-info btn-xs edit-btn" title="Update" href="{{ route('admin.subjects.edit', $cls->id) }}"> <i class="fas fa-pencil-alt"></i></a>
								   <form action="{{ route('admin.subjects.destroy', $cls->id) }}" method="POST">
										  @csrf
										  @method('DELETE')
