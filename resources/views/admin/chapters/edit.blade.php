						...
						<div class="row">          
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									@if(Illuminate\Support\Str::contains( $chapters->file,'storage/app/public/uploads'))
										<a href="{{ $chapters->file }}" target="_blank"><span style="color:blue;">Download PDF<span></a>
									@elseif(!empty($chapters->file))
									  <a href="{{ asset('public/uploads').'/'.$chapters->file }}"><span style="color:blue;">Download PDF<span></a>
									  @else
									  <img src="{{ asset('public/uploads').'/images.jpg' }}" alt="image" width="75"> 
									@endif 
								</div>
							...
							<div class="col-md-6"> 
								<div class="form-group">
									<label>External PDF Link(Any Source)</label>               
									<input type="text" name="link" class="form-control" placeholder="Enter PDF Link" value="{{ $chapters->link }}">
								</div>
							</div>
						</div>
