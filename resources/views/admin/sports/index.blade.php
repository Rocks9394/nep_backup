...
<div class="content-wrapper">
    <section class="content-header">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-2">
					<h1 class="act-header">Skill/Sports</h1>					
					 <a href="{{ route('admin.sports.create') }}" class="create-btn"> <input type="submit" value="Add" class="btn btn-sm btn-success "></a>
				</div>
				<div class="col-md-10">
	...
	<div class="row">
      ...
      <div class="card"> 
		...
		<div class="card-header filter-head">  
					<div class="row">
						<div class="col-md-12">					
							<form class="form-inline fltr-row " type="get" action="{{ route('admin.sports.index') }}">				
							   ...
							   <?php if(!empty($_GET['name'])){ $name = $_GET['name'];}else{ $name='';  } ?> 
								...
								<div class="fltr-srch form-group">                	 
										<input type="search" name="name" value="<?=$name?>" id="name" class="form-control  fltr-txt-bx @error('name') is-invalid @enderror"  placeholder="Search Sports" width="180px">
		  ...
		  <div class="row"> 
			<div class="col-12 div-count">
				<div class="fltr-count">Skill/Sports Found: <span class="no-counts">{{$count}}<span></div>
			</div>
        </div>	
              ...
              <?php $i=0; ?>
                 @foreach($sports as $sport)
                  <tr>
					...
					<td>
						<?php
						$classes = array_unique(explode(",", $sport->cls));
						if(!empty($classes)){
					...
					<td>
						<?php
						$skillareas = array_unique(explode(",", $sport->skillarea)); 
						if(!empty($skillareas)){
                     ...
                     <td>  
            <a  class="btn btn-info btn-xs edit-btn" href="{{ route('admin.sports.edit',$sport->id) }}"> <i class="fas fa-pencil-alt"></i></a>
