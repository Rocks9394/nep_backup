        ...
        <div class="container all-chaptr-cards mt-5">
            <div class="row">
                <div class="col-12">
                    <div class="heading-rw mt-3 mt-md-1 mb-0 p-0">
                        ...
                        <h1 class="ml-md-4 mb-0">{{$title}}-Test</h1>
                    </div>
                </div>
            </div>
            ...
            @foreach($sports as $sport)
                <div class="col-4 col-md-3 col-lg-2 col-xl-2 mb-4">
                    <a href="{{ route('sports.videos', $sport->sport_id) }}" target="_self" class="img-grid">
                        <span>{{ $sport->sport_name }}</span>
                        <img src="{{ asset('public/change-sports/' . $sport->img) }}" class="img-fluid rounded" alt="">
                    </a>
                </div>
            @endforeach
            </div>
