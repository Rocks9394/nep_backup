...
<style type="text/css">
	...
	.activity-info .activity-img::after, .activity-info .activity-pending .activity-img::before {
	    position: absolute;
	    margin: auto;
	    height: 24px;
	    padding: 6px;
        ...
        <div class="container">
            <div class="t-mrg2">
				<div class="all-chaptr-cards">
							...
							<div class="from__bx">
								...
								<div class="form-row mt-1 mt-lg-3">
									...
									<div class="col-12 col-md-4 col-lg">
										<select class="form-control mx-0 w-100 mb-3" name="by_class_id" id="by_class_id" onchange="getActivitiesDetail()">
									...
									<select class="form-control mx-0 w-100 mb-3" name="by_skillarea_id" id="by_skillarea_id" onchange="getActivitiesDetail()">
									...
									<select class="form-control mx-0 w-100 mb-3" name="by_sportskill_id" id="by_sportskill_id" onchange="getActivitiesDetail()">
									...
									<select class="form-control mx-0 w-100 mb-3" name="by_technique_id" id="by_technique_id" onchange="getActivitiesDetail()">
									...
									<div class="col-12 col-md-6 col-lg">
									<select class="form-control mx-0 w-100 mb-1" id="by_status" onchange="getActivitiesDetail()">
					...
					<div class="row">
						<div class="col-12"><p class="msg_info mt-3 mt-lg-5">Please select a class for Activities</p></div>
					</div>
					<div class="row">
						<div class="col-12">
							<form method="POST" class="row mt-2 pt-2" name="view-trainer-report" id="" action="{{ route('student.map.students') }}">
								{{method_field('post')}}
								@csrf
										<div class="col-12">
...
<script>
	    ...
	    jQuery.ajax({
	        ...
	        success: function(response) {
	            ...
	            $.each(response.activitieslist, function(key, val) {
	                ...
	                let imagepath = val.image?.includes("wp-content") ? val.image : val.image ? 'public/uploads/' + val.image
        ...
        jQuery.ajax({
            ...
            success: function(response) 
            {
                ...
                $.each(response.activitieslist, function(key, val) 
                {
					   ...
					   '<div class="activity-img" onclick="modelContent(' + val.activity_id + ', \'' + val.skillname + '\', \'' + val.sportsname + '\', \'' + val.techniquename + '\' , \'' + clsSecName + '\', \'' + tickMark + '\')">' +
					   '<div class="img_overlay"></div>' +
					   '<img class="card-img-top" src="' + imagepath + '" alt="' + val.title.toUpperCase()  +'">' +
					   '</div>' +
					   '<div class="card-body">' +
					   '<h5 class="card-title">' + val.title  +'</h5>' +
					   '<p class="d-flex justify-content-between"><span><strong>SkillArea</strong></span><span>' + val.skillname + '</span></p>' +
  ...
  function modelContent(ActivityId, skillarea, sports, technique, ClassSectionName, TickMark) 
  {
	    ...
	    console.log('activity-id-'+ActivityId+','+'skillarea-'+skillarea+','+'sports-'+sports+','+'techniue-'+technique);
		//alert(item);
        jQuery.ajax({
