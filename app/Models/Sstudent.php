...
class Sstudent extends Authenticatable
{
   ...
   protected $fillable = ['school_id','school_code','student_uid','student_name','gender','class_id','custom_class_id','section_id','dob','user_id','password', 'email_id','rollno','status','last_updated'];
