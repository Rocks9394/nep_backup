            ...
            <td>
                <table width="100%" border="0" cellpadding="8" cellspacing="0" 
                    ...
                    <tr>
                        ...
                        <td style="font-weight:500; border:1px solid orange; padding:2px 10px;"><?php echo e($studentsData->student_name); ?> (<?php echo e($studentsData->admissionnumber); ?>)</td>

                        <td style="background:#0A87CD; color:#fff; font-weight:500; padding:2px 10px;">Class</td>
                        <td style="font-weight:500; border:1px solid orange; padding:2px 10px;"><?php echo e($studentsData->display_classname.'-'.$studentsData->section); ?></td>

                        <td style="background:#0A87CD; color:#fff; font-weight:500; padding:2px 10px;">Roll No</td>
                        <td style="font-weight:500; border:1px solid orange; padding:2px 10px;"><?php echo e($studentsData->rollno); ?> </td>
                    </tr>   
                    <tr>
                        <td style="background:#0A87CD; color:#fff; font-weight:500; padding:2px 10px;">DOB</td>
                        <td style="font-weight:500; border:1px solid orange; padding:2px 10px;"><?php echo e($formattedDob); ?> (<?php echo e($age); ?> Yrs  <?php echo e($gender); ?>)</td>

                        <td style="background:#0A87CD; color:#fff; font-weight:500; padding:2px 10px;">School Code</td>
                        <td style="font-weight:500; border:1px solid orange; padding:2px 10px;"><?php echo e($studentsData->school_code); ?></td>

                        <td style="background:#0A87CD; color:#fff; font-weight:500; padding:2px 10px;">School</td>
                        <td style="font-weight:500; border:1px solid orange; padding:2px 10px;"><?php echo e($studentsData->school_name); ?></td>
