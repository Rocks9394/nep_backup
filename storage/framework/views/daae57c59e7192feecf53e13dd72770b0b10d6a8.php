            ...
            <div class="row">
                <div class="col-12 col-md">
                    <div class="heading-rw mt-0 mt-md-1 mb-0 p-0">
                        <?php if(auth()->guard('web')->check() || auth()->guard('sstudent')->check()): ?>
                ...
                <div class="col-12">
                    <div class="tab-content mt-4 mb-5">
                        ...
                        <div id="junior" class="tab-pane active show">
                            <div class="row">
                                <?php $__currentLoopData = $juniorVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $videoGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <div class="banner-bg-col d-flex justify-content-between align-items-start">
                                                    ...
                                                    <div class="banner-text-col d-flex flex-column">
                                                        <div class="test-name mb-2">
                                                            <h4 class="mb-2"><?php echo e($videoGroup['videos']->first()->skill_name); ?></h4>

                                                            
                                                            <div class="d-flex flex-wrap">
                                                                <?php $__currentLoopData = $videoGroup['videos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <div class="language mr-3 mb-2 d-flex align-items-center">
                                                                        ...
                                                                        data-skill-id="<?php echo e($video->skill_id); ?>"
                                                                        data-skill-name="<?php echo e($video->skill_name); ?>"
                                                                        data-lang="<?php echo e(strtolower($video->type_video)); ?>"
                                                                        data-video-url="<?php echo e($video->video_url); ?>"
                                                                        data-video-type="<?php echo e($video->type_video); ?>">
                                                                        <?php echo e(ucfirst(strtolower($video->type_video))); ?>
                                                    ...
                                                    <div class="test-icon">
                                                        <img src="<?php echo e(asset('public/icons/BatteryOfTests/' . $videoGroup['videos']->first()->icons)); ?>" 
                                                            alt="icon"
                                                            style="height: 70px;">
                                                    </div>
                        ...
                        <div id="senior" class="tab-pane fade">
                            <div class="row">
                                <?php $__currentLoopData = $seniorVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $videoGroup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-12 col-md-6">
                                        <div class="know-more-banner p-3 play-card mb-3">
                                            <div class="test-all-banner-col">
                                                <div class="banner-bg-col d-flex justify-content-between align-items-start">
...
document.addEventListener("DOMContentLoaded", function () {
    const allVideos = <?php echo json_encode($videoData, 15, 512) ?>;
