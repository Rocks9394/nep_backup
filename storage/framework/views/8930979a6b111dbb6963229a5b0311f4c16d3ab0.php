...
<?php $component = $__env->getContainer()->make(App\View\Components\SpeedGetStudents::class, ['classes' => $classes,'type' => $type,'cwsnType' => $pwd_category_id]); ?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const formName = String(<?php echo json_encode($TestTypeId, 15, 512) ?>); 
        ...
        $(document).on('submit', `#${formName}`, function(e) {
            ...
            const route = '<?php echo e(route("cwsn.types.submit")); ?>';
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status === 'success' || response.success === true) {
                        handleResponseMessages('success', 'Success!', response.message, {
                            confirmText: 'OK',
                            onConfirm: function () {
                                location.reload();
                            }
                        ...
                        handleResponseMessages('error', 'Failed', response.message || 'Action could not be completed.');
                    }
                },
                error: function (xhr) {
