    ...
    <div class="t-mrg2 mb-5 pb-5 px-4">
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="heading-rw mt-2" style=" margin-left: -18px;">
...
<?php echo $__env->make('layouts.filldart-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/nep/resources/views/reports/fitnessTestStatus.blade.php ENDPATH**/ ?>