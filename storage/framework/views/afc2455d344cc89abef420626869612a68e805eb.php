...
<?php $component = $__env->getContainer()->make(App\View\Components\DataListingComponent::class, ['id' => 'student-skill-reports-table','headers' => ['Class','Section','Roll No.','Student Name', 'Admission No.','Gender','Birth Date','Report','Download'],'columns' => [			       
			    ...
			    ],'ajaxUrl' => ''.e(route('skill.reports')).'','enableExportButtons' => false,'enableLengthMenu' => true,'exportButtonText' => 'Bulk Action','pageLength' => 100,'enableClassFilter' => false,'enableClassSectionFilter' => true,'enableSchoolTermsFilter' => true,'enableStatusFilter' => false,'searchPlaceholder' => 'Students Name | Admission','exportButtons' => [
                    [   
