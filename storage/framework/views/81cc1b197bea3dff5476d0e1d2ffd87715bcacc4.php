...
<?php endif; ?>
        ...
        <form method="POST" name="saveBMIRecord" id="save_bmi_record_id" action="">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form">
                        <h2 class="mb-2 mt-4 text-center">Enter Height and Weight Score</h2>
                        <div class="input-group input-group__2 mb-3">
                            ...
                            <span class="form-control">
                                ...
                                <input type="text" name="height" required class="form-control form-control-lg" id="heightInput" placeholder="--" maxlength="6">
                            </span>
                            <span class="form-control">
                                <label for="weightInput" class="form-label"> Weight(kgs)</label>
                                <input type="text" name="weight" required class="form-control form-control-lg" id="weightInput" placeholder="--" maxlength="7">
                            </span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.icsce-master-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/nep/resources/views/assessor/bmi.blade.php ENDPATH**/ ?>