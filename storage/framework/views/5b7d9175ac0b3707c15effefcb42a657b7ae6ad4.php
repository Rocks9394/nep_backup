...
<?php if(Auth::user()->role_id == '3' && $hasSchools && $getActiveTerm): ?>
<div class="mobile-bottom-nav">
    <a href="<?php echo e(route('fill.dart')); ?>" class="bottom-nav-item <?php echo e(request()->routeIs('fill.dart') ? 'active' : ''); ?>">
        <img src="<?php echo e(asset('uploads/icons/Dart.svg')); ?>" alt="Fill DART">
        <span>Fill DART</span>
    </a>

    <a href="<?php echo e(route('map.sports')); ?>" class="bottom-nav-item <?php echo e(request()->routeIs('map.sports') ? 'active' : ''); ?>">
        <img src="<?php echo e(asset('uploads/icons/MAP-Students.svg')); ?>" alt="Map Students">
        <span>Map Student</span>
    </a>

    <a href="<?php echo e(route('all-test')); ?>" class="bottom-nav-item <?php echo e(request()->routeIs('all-test') ? 'active' : ''); ?>">
        <img src="<?php echo e(asset('uploads/icons/taketest.svg')); ?>" alt="Take Test">
        <span>Take Test</span>
    </a>

    <a href="<?php echo e(route('activity.according.to.class')); ?>" class="bottom-nav-item <?php echo e(request()->routeIs('activity.according.to.class') ? 'active' : ''); ?>">
        <img src="<?php echo e(asset('uploads/icons/activities.svg')); ?>" alt="Activity Planner">
        <span>Activity</span>
    </a>
</div>
<?php endif; ?>
