                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-auto">
                                        ...
                                        <div class="btn-group btn-group-toggle justify-content-center p-0 my-2" data-toggle="buttons">
                                            <label class="btn btn-secondary btn-sm d-flex align-items-center <?php echo e($errors->any() ? '' : 'active'); ?>" style="gap:5px;">
                                                <input type="radio" name="options" id="option1" autocomplete="off" <?php echo e($errors->any() ? '' : 'checked'); ?>> 
                                            ...
                                            <label class="btn btn-secondary btn-sm d-flex align-items-center <?php echo e($errors->any() ? 'active' : ''); ?>" style="gap:5px;">
                                                <input type="radio" name="options" id="option2" autocomplete="off" <?php echo e($errors->any() ? 'checked' : ''); ?>> 
                            ...
                            <div id="mappedTrainersContainer" class="col-12" style="display: none;">
                                <div id="mapped_trainer_table_container" style="margin-top: 15px;">
                                    <div class="responsive">
                                            ...
                                            <table class="table table-bordered m-0">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $mappedTrainers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trainer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr data-userid="<?php echo e($trainer->id); ?>">
                                                        <td><?php echo e($trainer->self_registrationId ?? 'N.A.'); ?></td>
                                                        <td><?php echo e($trainer->name); ?></td>
                                                        <td><?php echo e($trainer->email); ?></td>
                                                        <td><?php echo e($trainer->phone); ?></td>
                                                        <td><span class="badge badge-success"><?php echo e($trainer->status); ?></span></td>
                                                        <td>
                                                        <?php if($trainer->status == 'Mapped'): ?>
                                                            <a href="#" data-trainer-id="<?php echo e($trainer->id); ?>" class="unmap-trainer-btn" id="unmap-trainer">Un-Map</a>
                                                        <?php else: ?>
                                                            <a href="#" data-trainer-id="<?php echo e($trainer->id); ?>" class="map-trainer-btn" id="map-trainer">Map</a>
                                                        <?php endif; ?>
                                                        </td>

                                                        <td  style="text-align: center;">
                                                            <a href="#" data-trainer-id="<?php echo e($trainer->id); ?>" class="remove-trainer-btn" id="remove-trainer">
                                ...
                                <div id="addTrainerForm" class="col-12" style="display: none;">
                                    <div style="background:#fff; padding:15px; border-radius:12px; margin-top:15px;">
                                        <?php echo $__env->make('auth.self_registration.trainer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    </div>
                                </div>
                            </div>
                    </div>
...
$(document).ready(function () {
    ...
    $("#trainer_search").autocomplete({
        source: "<?php echo e(route('autocomplete.trainer')); ?>",
        minLength: 2,
    ...
    $('.form-inline').submit(function (e) {
        ...
        $.ajax({
            url: "<?php echo e(route('autocomplete.trainer')); ?>",
            data: { term: query },
...
$(document).on('click', '.map-trainer-btn', function () {
    ...
    handleResponseMessages( 'warning',  'Are you sure?', 'Do you want to map this trainer with the school?', {
        ...
        onConfirm: () => { 
            $.ajax({
                url: "<?php echo e(route('trainer.map')); ?>",
                method: "POST",
                data: {
...
$(document).on('click', '.remove-trainer-btn', function () {
    ...
    let action = 'Remove';
    const trainerId = $(this).data('trainer-id');
    let route = "<?php echo e(route('remove.trainer')); ?>";
...
$(document).on('click', '.unmap-trainer-btn', function () {
    const trainerId = $(this).data('trainer-id');
     ...
     handleResponseMessages( 'warning',  'Are you sure?', 'Do you want to unmap this trainer from the school?', {
        ...
        onConfirm: () => { 
            $.ajax({
                    url: "<?php echo e(route('trainer.unmap')); ?>",
                    method: "POST",
                    data: {
                        _token: "<?php echo e(csrf_token()); ?>",
                        trainer_id: trainerId
