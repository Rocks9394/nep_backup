...
$(document).ready(function() {
    $('#save_push_up_id').submit(async function(e) { 
        ...
        await Swal.fire({
            ...
            $.ajax({
                url: '<?php echo e(route("push.up.record.submit")); ?>', // or your route URL
                method: 'POST',
                data: $(this).serialize(),
...
<?php echo $__env->make('layouts.icsce-master-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/nep/resources/views/assessor/muscular-endurance.blade.php ENDPATH**/ ?>