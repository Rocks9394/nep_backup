...
<h2 class="mb-4 text-center"><?php echo e($title); ?> Score</h2>

<form class="form row" method="POST" name="<?php echo e($TestTypeId); ?>" id="<?php echo e($TestTypeId); ?>" action="javascript:void(0);">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="action-bar py-3 p-0 d-flex justify-content-between">
                            <button type="button" id="reset_<?php echo e($TestTypeId); ?>" class="btn py-2 px-5 btn-outline-secondary">Reset</button>  
                            <button type="submit" id="submit_<?php echo e($TestTypeId); ?>" class="btn py-2 px-5 btn-primary disabled" disabled>Save</button>
                        </div>
                    </div>
                </div>
            </div>
