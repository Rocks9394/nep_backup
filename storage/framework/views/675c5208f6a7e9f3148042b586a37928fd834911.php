    ...
    <table style="width:100%; border-collapse:collapse; font-size:10px;">
        ...
        <tbody>
            <?php $__currentLoopData = $FmsReportData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $reportData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $rowCount = count($reportData) * 2; ?>
                <?php $__currentLoopData = $reportData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <?php if($index == 0): ?>
                            <td rowspan="<?php echo e($rowCount); ?>" style="vertical-align:top; font-weight:bold;">
                                <?php echo e($key); ?>
                        ...
                        <td style="text-align:center;">
                            <?php if(!empty($data['current_count'])): ?>
                                <img src="<?php echo e(public_path('assets/imgs/'.$data['current_count'].'smiles.png')); ?>" height="15">
                            <?php else: ?>
                                NA
                            <?php endif; ?>
                        </td>
                    ...
                    <tr style="border-bottom:1px solid #ccc;">
                        ...
                        <td style="text-align:center;">
                            <?php if(!empty($data['previous_count'])): ?>
                                <img src="<?php echo e(public_path('assets/imgs/'.$data['previous_count'].'smiles.png')); ?>" height="15">
                            <?php else: ?>
                                NA
                            <?php endif; ?>
                        </td>
    ...
    <table cellpadding="0" cellspacing="0" style="border:1px solid #ccc; width:100%;margin-bottom:5px; margin-top:5px; border-collapse:collapse; font-size:11px;">
        <tbody>
            ...
            <tr style="font-weight:bold; background-color:#ccc; color:#000; text-align:center;">
                <th style="padding:2px; border:1px solid #ccc;"><img src="<?php echo e(public_path('assets/imgs/1smiles.png')); ?>" height="15"></th>
                <th style="padding:2px; border:1px solid #ccc;"><img src="<?php echo e(public_path('assets/imgs/2smiles.png')); ?>" height="15"></th>
                <th style="padding:2px; border:1px solid #ccc;"><img src="<?php echo e(public_path('assets/imgs/3smiles.png')); ?>" height="15"></th>
                <th style="padding:2px; border:1px solid #ccc;"><img src="<?php echo e(public_path('assets/imgs/4smiles.png')); ?>" height="15"></th>
                <th style="padding:2px; border:1px solid #ccc;"><img src="<?php echo e(public_path('assets/imgs/5smiles.png')); ?>" height="15"></th>
            </tr>
...
</html><?php /**PATH C:\xampp\htdocs\nep\resources\views/reports/fitness/pdf/one-page-junior-f365.blade.php ENDPATH**/ ?>