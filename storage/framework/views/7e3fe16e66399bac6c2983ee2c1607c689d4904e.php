...
<section class="main-sec">
    <div class="container">
        ...
        <div class="row mb-4 thumbs-rw">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 offset-0">
                <div class="card chapter-bx mb-4">
                    <a href="<?php echo e(route('sport')); ?>"></a>
        ...
        <div class="row mb-5 thumbs-rw">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 offset-0">
                <div class="card chapter-bx mb-4">
                    <a href="<?php echo e(route('academics')); ?>"></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/nep/resources/views/index.blade.php ENDPATH**/ ?>