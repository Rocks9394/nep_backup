        ...
        <div class="warmup-card">
            ...
            <form id="warmup-email-form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select name="user_type" id="user_type" class="form-control-custom" >
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#warmup-email-form').on('submit', function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('warmup.email.store')); ?>", // Naming alignment schema targets
                    type: "POST",
                    data: formData,
