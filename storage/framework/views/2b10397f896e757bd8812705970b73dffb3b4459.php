...
$(document).ready(function() {
    $('#save_sit_and_reach_record_id').submit(function(e) {
        ...
        submitLoader();
        $.ajax({
            url: '<?php echo e(route("sit.and.reach.record.submit")); ?>', // or your route URL
            method: 'POST',
            data: $(this).serialize(),
...
<?php echo $__env->make('layouts.icsce-master-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/nep/resources/views/assessor/flexibility.blade.php ENDPATH**/ ?>