...
<?php $component = $__env->getContainer()->make(App\View\Components\DataListingComponent::class, ['id' => 'student-skill-reports-table','headers' => ['Class','Section','Roll No.','Student Name', 'Admission No.','Gender','Birth Date','Test Status','Report'],'columns' => [
			    ...
			    ],'ajaxUrl' => ''.e(route('fitness.report.test')).'','enableExportButtons' => false,'enableLengthMenu' => true,'pageLength' => 100,'enableClassFilter' => false,'enableClassSectionFilter' => true,'enableStatusFilter' => true,'searchPlaceholder' => 'Students Name | Admission','exportButtons' => [
                    [   
