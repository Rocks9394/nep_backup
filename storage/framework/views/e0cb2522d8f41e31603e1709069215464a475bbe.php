            ...
            <div class="row">
               <div class="col-12 col-lg-4 col-xl-3">
                  <div class="sport-summery">
                     <a href="<?php echo e(url('/learn-sports')); ?>"class="back-btn">
                     ...
                     <img src="<?php echo e(asset('public/change-sports/' . $sport_details->img)); ?>" class="img-fluid rounded-0" alt="Sports Img">

                     <div class="card-body chapter-dtls">
                           <h1 class="chapter-heading"><?php echo e($sport_details->name ?? ''); ?></h1>
                           <p class="card-text"><?php echo e($sport_details->desc ?? ''); ?>   </p>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-12 col-lg-8 col-xl-9">
                  <div class="row">
                     <div class="col-10 col-sm-10 col-md d-flex align-items-center">
                        <h2>Learn <?php echo e($sport_details->name ?? ''); ?></h2>
                     </div>
                  ...
                  <div class="expand-dv">
                     ...
                     <?php $__currentLoopData = $chaptersDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $details): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                     <div class="card">
                        <div class="card-header">
                           <div class="btn btn-link" data-toggle="collapse" data-target="#<?php echo e($details['chapter_name']); ?>" aria-expanded="false" aria-controls="collapse">
                              <div class="row">
                                 <div class="col">
                                    <?php echo e($key); ?>

                                    <label for="No of videos" class="no-of-videos mb-0">
                                       <?php if($details['chapterVideos'] && count($details['chapterVideos']) === 1): ?>
                                       1 Video
                                    <?php elseif($details['chapterVideos'] && count($details['chapterVideos']) > 1): ?>
                                       <?php echo e(count($details['chapterVideos'])); ?> Videos

                                    <?php else: ?>
                                       N.A.
                                    <?php endif; ?>
                                    </label>
                                    <h3 class="mt-2 mb-0 pt-1"><?php echo e($details['chapter_name'] ?? 'N.A.'); ?></h3>
                        ...
                        <div class="collapse" id="<?php echo e($details['chapter_name']); ?>">

                           <div class="card-body p-0">
                              <div class="activities-dv pr-0 pr-md-3 mt-2 pt-2 mb-0">                                
                                 <ul class="activity-list form-row">
                                    <?php $__currentLoopData = $details['chapterVideos']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <li class="col-12 col-md-6 col-lg-6 col-xl-4">
                                          <a href="javascript:void(0);"
                                             data-toggle="modal"
                                             data-target="#getTutorialVideos"
                                             onclick="getTutorialVideos(<?php echo e(json_encode($video->topic)); ?>, <?php echo e(json_encode($video->video_url)); ?>)">
                                             <span class="card">
                                                <img class="card-img-left" src="<?php echo e($video->thumbnail_url); ?>" alt="Card image cap">
                                                <span class="card-body">
                                                   <h6 class="card-title"><?php echo e($video->topic); ?></h6>
                                                </span>
                                             </span>
                                          </a>
                                       </li>
