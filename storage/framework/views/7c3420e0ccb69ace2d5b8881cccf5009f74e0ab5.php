          ...
          <div class="col-md-12">          
            <div class="update-activity">
              <!--<div class="card-header">
               ...
               <form method="POST" action="<?php echo e(route('admin.activities.update', $post->id)); ?>" enctype="multipart/form-data" id="add-activity">
				   <?php echo csrf_field(); ?>
						...
						<div class="row">
						  ...
						  <?php endif; ?>
								...
								<div class="form-group">
									<label>Name</label>	
									<input type="text" name="title" value="<?php echo e(preg_replace('/[^(\x20-\x7F)\x0A\x0D]*/','', $post->title)); ?>" class="form-control">
								</div> 
									   ...
									   foreach($teaching as $tch){					  
										...
										<div class="form-check form-check-radio form-check-inline">
										   <label class="form-check-label">
											<input class="form-check-input through_sport" <?php echo (in_array($tch->id, $teach_id) ? 'checked' : '');?> type="checkbox" name="teaching_through[]" id="inlineRadio<?=$tch->id?>" value="<?php echo e($tch->id); ?>"><?=$tch->name;?>
									...
									<div class="form-group">
										<?php $word = "wp-content"; $mystring = $post->image;
											...
											if(strpos($mystring, $word)!== false){ ?>
												<img src="<?php echo e($post->image); ?>" width="100" height="100">	
											<?php } else if (file_exists('public/uploads/'.$post->image)){ ?>
											<img src="<?php echo e(asset('public/uploads').'/'.$post->image); ?>" alt="" width="100" height="100">							
											<?php } else { ?>				 
								...
								<div class="form-group">
									...
									<input type="text" name="url" value="<?php echo e($post->url); ?>" class="form-control" placeholder="Enter URL">
								</div>
								...
								<div class="form-group">
									...
									<textarea class="form-control" id="learning_outcomes" name="learning_outcomes" placeholder="Learning Outcomes"><?php echo e($post->learning_outcomes); ?></textarea>
								</div>
								...
								<div class="form-group">
									...
									<textarea id="description" class="form-control" name="description" placeholder="Description"><?php echo e(preg_replace('/[^(\x20-\x7F)\x0A\x0D]*/','', $post->description)); ?></textarea>
								</div>
								...
								<div class="form-group">
								   <label for="exampleInputEmail1" scope="col">Variations</label>							  
										 <textarea class="form-control" id="variations" name="change_it" placeholder="Change it (Variations)"><?php echo e($post->change_it); ?></textarea>
								</div>
							...
							<div class="form-group">
							    ...
							    <textarea class="form-control" id="coaching" name="coaching" placeholder="Coaching (Teaching Tips)"><?php echo e($post->coaching); ?></textarea>
                            </div>
						    ...
						    <div class="form-group">
							    ...
							    <textarea class="form-control" id="equipment" name="equipment" placeholder="Equipment"><?php echo e($post->equipment); ?></textarea>
                            </div>
								...
								<ul class="select2-selection__rendered act-concepts">							 
									...
									if(!empty($actconcepts)){								
										...
										<li class="tooltip1 select2-selection__choice multiact multi-tag" title="Concepts"> 
										   <ul>
										   <li class="act-cls"><span><?php echo e($cls->clsname); ?> </span> </li> 
										   <li class="act-sub"> <span><?php echo e($cls->subjectname); ?>  </span></li>
										   <li class="act-cptr"> Chapter: <span> <?php echo e($cls->chaptername); ?> </span></li>
										   <li class="act-cont"> Concept: <span><?php echo e($cls->conceptname); ?> </span></li>
											 
											
										   </ul>
											<span class="select2-selection__choice__remove selmultiact" data-selectid="<?php echo e($cls->con_id); ?>"  role="presentation"> x</span>
										</li>
									<?php } } ?>	
								</ul>
								...
								<ul class="select2-selection__rendered act-concepts">							 
									...
									if(!empty($acttechniques)){								
										...
										<li class="tooltip1 select2-selection__choice multiact multi-tag" title="Concepts"> 
										   <ul>
										   <li class="act-cls"><span><?php echo e($cls->clsname); ?> </span> </li> 
										   <li class="act-sub"> <span>Skillarea: <?php echo e($cls->skillareaname); ?>  </span></li>
										   <li class="act-cptr"> Sports/Skill: <span> <?php echo e($cls->sportsname); ?> </span></li>
										   <li class="act-cont"> Technique: <span><?php echo e($cls->techniquename); ?> </span></li>
											
										   </ul>
											<span class="select2-selection__choice__remove delskill" data-technique="<?php echo e($cls->technique_id); ?>"  data-cls="<?php echo e($cls->class_id); ?>" data-skillarea="<?php echo e($cls->skillarea_id); ?>" data-sportskill="<?php echo e($cls->sportskill_id); ?>" role="presentation"> x</span>
...
?>
 ...
 <script>
	...
	$('#actskillsave').click(function(event){
		...
		jQuery.ajax({
			url: "<?php echo e(route('activitytechnique')); ?>",     
			type: "POST" ,
			data:{ 
		        "acdata": skillval,
				"act_val" : act_val,
	...
	$('#actconsave').click(function(event){
		...
		jQuery.ajax({
			url: "<?php echo e(route('activityconcept')); ?>",     
			type: "POST" ,
			data:{ 
		        "acdata": conceptval,
				"act_val" : act_val,
   ...
   // alert('-----');
	...
	$("span.delskill").click(function(e){
	    ...
	    if(technique_id.length > 0 ){ 
			...
			if(checkstr == true){
			  $.ajax({
				url: "<?php echo e(route('techniquedelete')); ?>",
				data: {"actid":actid,"technique_id":technique_id,"class_id":class_id,"skillarea_id":skillarea_id,"sportskill_id":sportskill_id,"_token": "<?php echo e(csrf_token()); ?>"} ,
				type: 'POST',
				success:function(response){
				 //console.log(response);
					if((response.errors)){
    ...
    var actid = $('#sport_act').val();	
	    ...
	    if(selc.length > 0 ){ 
          //alert(selc);
			...
			if(checkstr == true){
			  $.ajax({
				url: "<?php echo e(route('conceptsdelete')); ?>",
				data: {"actid":actid,"conc_id":selc,"_token": "<?php echo e(csrf_token()); ?>"} ,
				type: 'POST',
				success:function(response){
				 //console.log(response);
					if((response.errors)){
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nep\resources\views/admin/activities/edit.blade.php ENDPATH**/ ?>