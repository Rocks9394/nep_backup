...
<script>
    ...
    function getStudentsList(classCustom){
        ...
        if (classCustom) {
            fetch(`<?php echo e(route('studentRollNo.autocomplete')); ?>?class_id=${classCustom}&query=`)
    ...
    //         return fetch(`<?php echo e(route('studentRollNo.autocomplete')); ?>?class_id=${classCustom}&test_status=${testStatus}&skillReportId=${skillReportId}&testType=${testType}&query=`)
    //             .then(response => response.json())
    //             .then(data => {
...
<?php /**PATH /var/www/nep/resources/views/layouts/icsce-master-footer.blade.php ENDPATH**/ ?>