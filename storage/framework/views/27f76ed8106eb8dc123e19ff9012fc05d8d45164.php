      ...
      <div class=" all-chaptr-cards">
         ...
         <form method="POST" name="view-trainer-report" id="reportform" action="javascript(0);">
            <div class="row">
               ...
               <div class="col-auto">
                   <label class="mb-0">
                     <a class="btn btn-link d-flex justify-content-center align-items-center" style="gap: 5px; width: auto; min-width: auto;" href="<?php echo e(route('modify.trainer.record')); ?>"><span class="d-flex justify-content-center align-items-center"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
   ...
   $(document).ready(function() {
      ...
      function loadDataTable(condition) {
        ...
        `);
         ...
         var route = "<?php echo e(route('view-trainer')); ?>";
         var method = 'GET';
...
<?php echo $__env->make('layouts.filldart-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/nep/resources/views/viewtrainer/index.blade.php ENDPATH**/ ?>