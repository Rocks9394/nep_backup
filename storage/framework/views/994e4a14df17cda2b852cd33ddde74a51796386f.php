    ...
    <div class="container">
        ...
        <div class="my-3">
            ...
            <div class="row no-gutters">
                ...
                <?php if((in_array((string) $classId, $juniorClassess) || in_array((string) $classId, $seniorClassess)) && $fitnessTest->isNotEmpty()): ?>
        ...
        <div class="form-row download-report mb-4">
            <div class="col-12 col-sm-4 col-lg-4 mb-3">
                ...
                <a href="<?php echo e(route('reports.view.test')); ?>" class="btn btn-primary btn-lg w-100" target="_blank">View Report </a>
            </div>
            <div class="col-12 col-sm-4 col-lg-4 mb-3">
                <!-- <a href="#" class="btn btn-primary btn-lg w-100" onclick="availbleSoon();">Download Report </a> -->
                <a href="<?php echo e(route('download.fitness.reports')); ?>" class="btn btn-primary btn-lg w-100">Download Report </a>
            </div>
            <div class="col-12 col-sm-4 col-lg-4 mb-3">
