                    ...
                    <form id="security-questions-form" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="question1" class="form-control" required>
                                ...
                                <?php $__currentLoopData = $SecurityQuestions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($value->id); ?>"><?php echo e($value->question); ?></option>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        finishBtn.addEventListener('click', function() {
            ...
            window.location.href = `<?php echo e(route('filldart.dashboard')); ?>`; 
        });
        ...
        function submitSecurityQuestions() {
            ...
            fetch('<?php echo e(route("security.update-questions")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
        ...
        function submitPasswordChange1() {
            ...
            fetch('<?php echo e(route("security.update-password")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
