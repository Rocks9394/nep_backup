                ...
                <div class="student-info">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-12 col-xl">
                            <span class="lb">Name:</span><?php echo e($dailyReportCard['studentProfile']['name']); ?><span></span>
                        </div>
                        <div class="col-6 col-lg-3 col-xl">
                            <span class="lb">Class:</span><?php echo e($dailyReportCard['studentProfile']['class']); ?> - <?php echo e($dailyReportCard['studentProfile']['section'] ?? ''); ?><span></span>
                        </div>
                        <div class="col-6 col-lg-3 col-xl">
                            <span class="lb">Roll No:</span><?php echo e($dailyReportCard['studentProfile']['rollno']); ?><span></span>
                        </div>
                        <div class="col-6 col-lg-3 col-xl">
                            <span class="lb">DOB:</span><?php echo e(date('d-M-Y', strtotime($dailyReportCard['studentProfile']['dob'])) ?? 'N.A'); ?><span></span>
                        </div>
                        <div class="col-6 col-lg-3 col-xl">
                            <span class="lb">Gender:</span><?php echo e($dailyReportCard['studentProfile']['gender']); ?><span></span>
                        </div>
                    </div>
                </div>    
            </div>
                ...
                <div class="row mt-4">               
                    <div class="col-12">                        
                        <div class="row activity_cards mb-5" id="report_card_container">
                            <?php echo $__env->make('parent.partials.daily_tracker_details', ['dailyReportCard' => $dailyReportCard], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>                       
                    </div>                
                </div>
            </div>
...
<script>
  ...
  { 			   
    ...
    $('#session_term').on('change', function () {
        ...
        if (sessionTermId) {
            $.ajax({
                url: "<?php echo e(route('skill.dailyreport')); ?>",
                type: 'GET',
