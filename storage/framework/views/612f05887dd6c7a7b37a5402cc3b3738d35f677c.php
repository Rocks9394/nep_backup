...
<head>
    ...
    <style>
        *, body { margin: 0; padding: 0; }
        ...
        .page-3 td {  margin: 0; padding: 1px 4px 2px 4px;  white-space:normal;  white-space: normal; /* collapses leading spaces/newlines */ }
                    ...
                    <tr>
                        <td style="border-collapse: collapse;">
                            <div style="position: relative; background-color: #fff;">
                                ...
                                <img src="<?php echo e(public_path('assets/reports/report-cover-img.jpg')); ?>" alt="" style="width: 76%; z-index:2; position: relative; top:0;">
                            </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <?php if(!empty($studentsData->logo)): ?> 
                                                        <img src="<?php echo e(public_path('assets/uploads/logos/' . $studentsData->logo)); ?>" alt="" style="padding: 0px 0px 5px 46px; height: 100px;">
                                                    <?php else: ?>
                                                        <img src="<?php echo e(public_path('assets/uploads/logos/default_school-logo.png' )); ?>" alt="" style="padding: 0px 0px 5px 46px; height: 100px;">      
                                                    <?php endif; ?>
                                                            ...
                                                            <td colspan="2" style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #e5e5e5; width: 100%; text-align: center; font-weight: 600; font-size: 18px;"><?php echo e($studentsData->student_name); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td colspan="2" style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px;">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #e5e5e5; width: 100%; text-align: center; font-weight: 600;"><?php echo e($studentsData->display_classname); ?>-<?php echo e($studentsData->section); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td style="padding: 6px 0; width:55%;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #e5e5e5; width: 100%; text-align: center; font-weight: 600;"><?php echo e($studentsData->rollno ?? ''); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #e5e5e5; width: 100%; text-align: center; font-weight: 600;"><?php echo e($studentsData->admissionnumber); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #e5e5e5; width: 100%; text-align: center; font-weight: 600;"><?php echo e($gender); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td colspan="2" style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #e5e5e5; width: 100%; text-align: center; font-weight: 600;"><?php echo e($studentsData->school_name); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #e5e5e5; width: 100%; text-align: center; font-weight: 600;"><?php echo e($studentsData->school_code); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #e5e5e5; width: 100%; text-align: center; font-weight: 600;"><?php echo e($studentsData->apaarId ?? ''); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                    ...
                                    <td style="width:300px;">
                                        <?php if(!empty($studentsData->logo)): ?>                                        
                                            <div style="position: absolute; top: 30px; left:22px; display: flex; align-items: center; z-index: 1;">
                                                <img src="<?php echo e(public_path('assets/uploads/logos/' . $studentsData->logo)); ?>" alt="" style="width: auto; height: 50px; object-fit: contain;">
                                            </div>
                                        <?php else: ?>
                                            <div style="position: absolute; top: 30px; left:22px; display: flex; align-items: center; z-index: 1;">
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" style="width: 94%; border: 0; border-collapse: collapse; margin: auto;">
                                <tr>
                                    <td style="border-bottom: 3px solid #E60A00;">
                                        <div style="align-items: center; color: #fff; font-size: 18px; font-weight: 600; overflow:hidden; height: 32px;">
                                            <div style="float:left; padding: 1px 0px 3px 10px; background: #E60A00; margin-bottom: 0px;">Physical Fitness Assessment for <?php echo e($studentsData->class); ?>-<?php echo e($studentsData->section); ?></div>                                            
                                ...
                                <tr>
                                    <td style="padding: 6px 10px 6px 0px; color:#000; font-size: 16px; font-weight: 600;"><?php echo e($displayKey); ?></td>
                                </tr>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; font-size: 13px; border-collapse: collapse; color:#333;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding: 0px 4px 2px 6px; font-weight: 500; color:#000; text-align: center;"><?php echo e($value[0]['created_at'] ?? '---'); ?></td>
                                                ...
                                                <td>
                                                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border-top: 1px solid transparent; border-left: 1px solid #00A923; border-right: 1px solid #00A923; border-bottom: 1px solid #00A923; font-size: 13px; border-collapse: collapse; color:#333;">
                                                        <tr>
                                                            ...
                                                            <td style="padding:0px 4px 2px 8px; font-size:13px;"><?php echo e($value[0]['recommendation'] ?? '---'); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; font-size: 13px; border-collapse: collapse; color:#333;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding: 0px 4px 2px 6px; font-weight: 500; color:#000; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;"><?php echo e($value[0]['created_at'] ?? '---'); ?></td>
                                                                        <td style="padding: 0px 4px 2px 6px; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;"><?php echo e($value[0]['score'] ?? '---'); ?></td>
                                                                        <td style="padding: 0px 4px 2px 6px; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;"><?php echo e($value[0]['Level'] ?? '---'); ?></td>
                                            ...
                                            <tr>
                                                <td>
                                                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border-top: 1px solid transparent; border-left: 1px solid #00A923; border-right: 1px solid #00A923; border-bottom: 1px solid #00A923; font-size: 13px; border-collapse: collapse; color:#333;">
                                                        <tr>
                                                            <td style="border-top: 1px solid #00A923; background-color: #00A923; padding: 0px 4px 2px 4px; padding: 0px 10px 3px 10px; color: #fff; text-align: center; width: 100px; font-weight: bold;">Recommendation</td>
                                                            <td style="padding:0px 4px 2px 8px; line-height:14px; font-size:13px;"><?php echo e($value[0]['recommendation'] ?? '---'); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
            ...
            <td>
                <table cellpadding="0" cellspacing="0" style="border: 0; border-collapse: collapse; margin: auto; width:94%;">
                            <tr>
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0; border-collapse: collapse; border:1px solid #F28F0C; font-size: 12px; text-align:left; line-height:12px;">
                                            <tr style="background-color: #0A87CD; color:#fff; font-size: 13px; ">
                                ...
                                <tr>
                                    <td>
                                        <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #0A87CD; font-size: 12px; border-collapse: collapse; color:#000;">
                                            ...
                                            <tr>
                                                <td colspan="8" style="padding: 4px; border:1px solid #0A87CD;">
                                                    <p style="text-align:center;">
                                                        <span style="font-weight:bold;">Note :</span>
                                                        No Fitness Benchmarks available for a <?php echo e($age); ?>-year-old <?php echo e($gender); ?> in <?php echo e($studentsData->class); ?>
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="text-align:center;">
                                                    <?php if(is_array($getBmiBenchmark) && count($getBmiBenchmark) > 0): ?>
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;"><?php echo e($getBmiBenchmark['UW'] ?? 'N/A'); ?></td>
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;"><?php echo e($getBmiBenchmark['N'] ?? 'N/A'); ?></td>
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;"><?php echo e($getBmiBenchmark['OW'] ?? 'N/A'); ?></td>
                                                        <td style="padding:5px 10px; border:1px solid #0A87CD;"><?php echo e($getBmiBenchmark['OB'] ?? 'N/A'); ?></td>
                                                    <?php endif; ?>
                                                </tr>
...
</html><?php /**PATH C:\xampp\htdocs\nep\resources\views/reports/fitness/senior-report.blade.php ENDPATH**/ ?>