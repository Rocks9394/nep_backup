...
<body>
                        ...
                        <td>
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <?php $__currentLoopData = $orderedReportData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        <td style="padding: 6px 8px 6px 0px; color:#000; font-size: 16px; font-weight: 600;"> <?php echo e($displayKey); ?></td>
                                    </tr>
                                                                ...
                                                                <tr>
                                                                    <td style="width: 50%;">
                                                                        <table border="1" cellpadding="0"
                                                                            ...
                                                                            <tr>
                                                                                <td style="padding: 0px 4px 2px 6px; font-weight: 500; color:#000; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;">
                                                                                    <?php echo e($value['Current_Term'][0]['created_at'] ?? '---'); ?> </td>
                                                                                <td style="padding: 0px 4px 2px 6px; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;">
                                                                                   <?php echo e($currentScore ?? '---'); ?> </td>
                                                                                <td style="padding: 0px 4px 2px 6px; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;">
                                                                        ...
                                                                        <table border="1" cellpadding="0"
                                                                            ...
                                                                            <tr style="background-color: #fecd0a;">
                                                                                <td style="font-weight: 500; width: 20%; background-color:#0A87CD; padding: 0px 4px 2px 6px; border: 1px solid #0A87CD; color:#fff; text-align: center;"
                                                                                    rowspan="2">Previous Term</td>
                                                                                <td style="font-weight: 500; width: 25%; padding: 0px 4px 2px 6px; border: 1px solid orange; color:#000; text-align: center; font-weight: bold;">
                                                                                    Date</td>
                                                                                <td style="font-weight: 500; width: 28%; padding: 0px 4px 2px 6px; border: 1px solid orange; color:#000; text-align: center; font-weight: bold;">
                                                                                    Score</td>
                                                                                <td style="font-weight: 500; padding: 0px 4px 2px 6px; border: 1px solid orange; color:#000; font-weight: bold; text-align: center;">
                                                                                    Level</td>
                                                                            </tr>

                                                                            <tr>
                                                                                <td style="padding: 0px 4px 2px 6px; font-weight: 500; color:#000; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;">
                                                                                    <?php echo e($value['Previous_Term'][0]['created_at'] ?? '---'); ?></td>
                                                                                <td style="padding: 0px 4px 2px 6px; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;">
                                                                                    <?php echo e($previousScore ?? '---'); ?></td>
                                                                                <td style="padding: 0px 4px 2px 6px; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;">
                                                                                    <?php echo e($previousLevel ?? '---'); ?></td>
                                                                            </tr>
                                                            ...
                                                            <table border="1" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td
                                                                        ...
                                                                        <?php echo e($value['Current_Term'][0]['recommendation'] ?? '---'); ?></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                        ...
                                        <table border="1" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr style="background-color: #0A87CD;">
                                                <td style="padding: 5px 10px; font-weight: bold; color:#fff; font-size: 14px;"
                                                    colspan="8">Fitness Benchmarks for <?php echo e($age); ?> years  <?php echo e($gender); ?></td>
                                            </tr>
    ...
    <?php else: ?>
         <?php echo $__env->make('reports.fitness.primary-report', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
    <?php endif; ?>
    ...
    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; page-break-before: always;">
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 94%; border: 0; border-collapse: collapse; margin: auto;">
                        ...
                        <td style="border-bottom: 3px solid #E60A00;">
                            <div style="align-items: center; color: #fff; font-size: 18px; font-weight: 600; overflow:hidden; height: 32px;">
                                <div style="float:left; padding: 1px 0px 3px 10px; background: #E60A00; margin-bottom: 0px;">
                                    Developmental Skills for <?php echo e($studentsData->class); ?>-<?php echo e($studentsData->section); ?></div>
                                ...
                                <tr>
                                    <td style="vertical-align: top;">
                                        <table border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="padding: 1px 4px 2px 6px; font-weight: 500; color:#000; border: 1px solid orange;"> <?php echo e($data['Test_Name'] ?? ''); ?></td>
                                                ...
                                                <td style="padding: 1px 4px 2px 6px; font-size: 12px; border: 1px solid orange;">
                                                    <?php echo e($data['recommendation'] ?? ''); ?>
                    ...
                    <tr>
                        <td style="padding: 1px 10px 3px 10px; background:#0A87CD; color:#fff; font-size: 16px; font-weight: 600;">
                            Developmental Stages for <?php echo e($age); ?> Years <?php echo e($gender); ?></td>
                    </tr>

                    <tr>
                        <td style="vertical-align: top;">
                           <?php echo $__env->make('reports.fitness.templates.fms-benchmark', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="vertical-align:top;">
                            <?php switch($studentsData->class_id):
                                case (18): ?>
                                    <?php echo $__env->make('reports.fitness.templates.posture', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php break; ?>
                                <?php case (14): ?>
                                    <?php echo $__env->make('reports.fitness.templates.olympics-paralympics', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> 
                                    <?php break; ?>
                                <?php case (22): ?>
                                <?php case (23): ?>
                                    <?php echo $__env->make('reports.fitness.templates.daily-routine-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                    <?php break; ?>
                            <?php endswitch; ?>                                   
                        </td>
                    </tr> 
        ...
        <?php if(!in_array($studentsData->class_id, [22, 23])): ?>
        <tr>
            <td>
                <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
                    <tr>
...
<?php /**PATH C:\xampp\htdocs\nep\resources\views/reports/fitness/pdf/junior-report.blade.php ENDPATH**/ ?>