                ...
                <div class="form-row" style="justify-content: center;">
                    ...
                    <?php if((Auth::user()->role_id == '3' && $hasSchools) && (Auth::user()->role_id == '3' && $getActiveTerm)): ?>
	                    ...
	                    <div class="col-4 col-md-3 col-lg-2 col-xl-2 mb-4">
	                        <a href="<?php echo e(route('view-trainer')); ?>" data-id="" class="box"><div><img class="img-fluid" alt="" src="<?php echo e(asset('public/uploads/icons/viewDart.svg')); ?>"></div><span>View DART</span></a>
	                    </div>
	                    ...
	                    <div class="col-4 col-md-3 col-lg-2 col-xl-2 mb-4">
							...
							<img class="img-fluid" alt="" src="<?php echo e(asset('public/uploads/icons/lc_test-status.svg')); ?>"></div><span>Fitness Test Status <br> (Upto Class-3)</span></a>
						</div>
                    ...
                    <?php if(Auth::user()->role_id == '4'): ?>
	                    ...
	                    <div class="col-4 col-md-3 col-lg-2 col-xl-2 mb-4">
							...
							<img class="img-fluid" alt="" src="<?php echo e(asset('public/uploads/icons/fa.svg')); ?>"></div><span>Assessment Report</span></a>
						</div>
						<div class="col-4 col-md-3 col-lg-2 col-xl-2 mb-4">
							<a href="<?php echo e(route ('trainer.lowerclass.status')); ?>" class="box"><div>
							<img class="img-fluid" alt="" src="<?php echo e(asset('public/uploads/icons/lc_test-status.svg')); ?>"></div><span>Fitness Test Status <br> (Upto Class-3)</span></a>
					...
					<?php if(Auth::user()->id == 974): ?>
						...
						<div class="col-4 col-md-3 col-lg-2 col-xl-2 mb-4" id="activity_gallary">
							...
							<img class="img-fluid" alt="" src="<?php echo e(asset('public/uploads/icons/age-report.svg')); ?>"></div><span>Activity Gallary</span></a>
						</div>
					<?php endif; ?>
...
<?php echo $__env->make('layouts.filldart-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/nep/resources/views/fill-darts/dashboard.blade.php ENDPATH**/ ?>