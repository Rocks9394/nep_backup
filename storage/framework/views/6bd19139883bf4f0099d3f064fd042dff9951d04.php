...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('resources/images/goforfit-logo.png')); ?>" sizes="32x32" />
    <link rel="icon" href="<?php echo e(asset('resources/images/goforfit-logo.png')); ?>" sizes="192x192" />
            ...
            <div class="container">
                <div class="cred-bx">
                    <figure class="text-center mb-4 pb-2"><img alt="GoforFit"
                            src="<?php echo e(asset('resources/images/gofor-fit-logo.svg')); ?>"></figure>
                    <div class="card card-signin">
                        <div class="card-body">
                            <h5 class="card-title text-center"><?php echo e(__('Login')); ?></h5>
                            <form action="<?php echo e(route('admin.postlogin')); ?>" method="POST" id="frontadmin"
...
unset($__errorArgs, $__bag); ?>" name="password"
                                ...
                                <div class="custom-control custom-checkbox mb-3">
                                    ...
                                    <label for="customCheck1"><?php echo e(__('Remember me')); ?></label>
                                </div>
...
</html><?php /**PATH C:\xampp\htdocs\nep\resources\views/admin/login.blade.php ENDPATH**/ ?>