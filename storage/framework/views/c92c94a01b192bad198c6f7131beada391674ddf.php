...
<?php $__env->startSection('content'); ?>
   ...
   <?php if(!empty($activity[0])){ ?>
    <div class="">         
        ...
        <div class="container">
            <ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="<?php echo e(url('sport')); ?>"><?php echo e($title); ?></a></li>
               <li class="breadcrumb-item active" aria-current="page"><?php echo e($activity[0]->title); ?></li>
            </ol>
   </div>
        </nav>		
        <div class="container">
            <div class="concepts-area">
                <div class="row">
                    <div class="col-12 col-lg-4">
                        <div class="card card-details ml-0 ml-lg-3">
                          <button class="goback back-btn" onclick="goBack()"><img src="<?php echo e(asset('resources/images').'/'.'back-arrow.png'); ?>" alt=""><span class="back-to-chptr"><svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M2.117 12l7.527 6.235-.644.765-9-7.521 9-7.479.645.764-7.529 6.236h21.884v1h-21.883z"/></svg>Back to Chapters</span></button>
						   <?php
						   
							$word = "wp-content";										
							if(strpos($activity[0]->image, $word)!== false){ ?>
							 <figure><img class="card-img-top" src="<?php echo e($activity[0]->image); ?>" alt="Card image cap"></figure>
							<?php } else if(file_exists('public/uploads/'.$activity[0]->image)){ ?>
                                <figure><img class="card-img-top" src="<?php echo e(asset('public/uploads').'/'.$activity[0]->image); ?>" alt="Card image cap">	</figure>						
							<?php } else{ ?>				 
                                <figure><img  class="card-img-top" src="<?php echo e(asset('resources/images').'/'.'default-chapter-img.png'); ?>" alt="Card image cap"></figure>
							<?php } ?>														
							<div class="card-body chapter-dtls">
                                <!--<span class="no-concents"><?php echo e($total); ?> Activities</span>-->
                                <p class="chapter-info-txt">Activity</p>
                                <h1 class="chapter-heading"><?php echo e($activity[0]->title); ?></h1>
							...
							?>
							 ...
							 <?php if(!empty($actconcepts)): ?>
						<div style="background-color:#eee;color:black;padding:16px;">
								
										
										<?php $__currentLoopData = $actconcepts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											
										<strong><?php echo e($cls->clsname); ?> </strong>&nbsp;
										
										<strong><?php echo e($cls->subjectname); ?> </strong>
										<br>Chapter:
										<strong><?php echo e($cls->chaptername); ?></strong><br>
										Concept:
										<strong><?php echo e($cls->conceptname); ?></strong><br>
										<br>
							...
							<?php if(!empty($acttechniques)): ?>	
							
														
								<?php $__currentLoopData = $acttechniques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								...
								<br>Skill:
								<strong><?php echo e($cls->skillareaname); ?></strong>&nbsp; 
								<br>Sports:
								<strong><?php echo e($cls->sportsname); ?></strong><br>
								Technique:
								<strong><?php echo e($cls->techniquename); ?></strong><br>
								<br>
								<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="row">
                            <div class="col">
                                <div onclick="copyContent()" class="mt-3 activity-rw heading-rw" onclick="myFunction()">
                                    <h2 id="myText" ><?php echo e($activity[0]->title); ?> </h2>
						...
						<h3>Description Of Activity</h3>
							...
							<?php } ?>
							  ...
							  <?php if(!empty($activity[0]->coaching)){ ?>
							   <h3>Coaching  Tips</h3>							  
								<span class="hint"><img src="<?php echo e(asset('resources/images/hint-i.png')); ?>" alt=""> 
				...
				<br>
				 ...
				 <?php $admins_role =Auth::guard('admin')->user()->role_id; ?>
				 <?php if($admins_role == '4' || $admins_role == '1'): ?>
				 <input type="hidden" name="activity_id" id="activity_id" value="<?php echo e($activity[0]->id); ?>">
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-8">
						...
						<div class="col-md-4">
							 <label for="exampleInputEmail1" scope="col">Experts Comment</label>
                                <textarea class="form-control" name="comments" id="comments"
                                                placeholder="Experts Comment" style="width:440px;height:210px;background-color:#FFF;"><?php echo e(old('comments')); ?></textarea>
						...
						<label for="exampleInputPassword1">Comments</label>
							...
							<table class="table table-striped" id="tabledetails">
								...
								<?php if(!empty($comments)): ?>
									...
									<tr id="cmt<?php echo e($cmt->id); ?>">
									<td><?php echo e($cmt->activity_sports); ?></td>
									<td><?php echo e($cmt->activity_subject); ?></td>
									<td><?php echo e($cmt->qualityofactivity); ?></td>
									<td><?php echo e($cmt->creativity); ?></td>
									<td><?php echo strip_tags("$cmt->comment"); ?></td>
									<td><?php echo e($cmt->name); ?></td>
									<td><a href="javascript:void(0)" onclick="deleteComment(<?php echo e($cmt->id); ?>)" >delete</a>
									

									<a href="javascript:void(0)" onclick="editComment(<?php echo e($cmt->id); ?>)" >edit</a>
   ...
   <script type="text/javascript">
		$('#commentactivity').on('submit',function(e){
			...
			$.ajax({
				...
				type:"POST",
				data:{"_token":"<?php echo e(csrf_token()); ?>","rating":rating,"comments":comments,"activity_id":activity_id,"star1":star1,
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/nep/resources/views/actconcepts.blade.php ENDPATH**/ ?>