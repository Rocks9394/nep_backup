                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%;">
                            ...
                            <table cellpadding="0" cellspacing="0" style="width:100%; height:15%;">
                                <tr>
                                    ...
                                    <td style="position: relative; width: 220px;">
                                        <img src="<?php echo e(public_path('assets/reports/yellow-dot.png')); ?>"
                                            style="width: 50px;
                                                position: absolute;
                                                left: -50px;
                                                top: -33px;">
                                        ...
                                        <div style="position:absolute; top:0;">
                                            <img src="<?php echo e(public_path('assets/reports/logo-bg.jpg')); ?>"
                    ...
                    <tr>
                        <td style="position:relative; z-index:1;">
                            <img src="<?php echo e(public_path('assets/reports/report-cover-img.png')); ?>"
                                style="width:85%; height:60%;">

                            <img src="<?php echo e(public_path('assets/reports/report-graphic.png')); ?>"
                                ...
                                <tr>
                                    <td style="width:200px; background:#FBCA01; vertical-align:top; position:relative; z-index:5; margin-top:-120px;">
                                        <div style="position:relative;">
                                            ...
                                            <img src="<?php echo e(public_path('assets/reports/aa-bg.png')); ?>"
                                                style="width:200px;">
                                        </div>
                                    </td>
                                    <td style="padding:30px;">
                                        <img src="<?php echo e(public_path('assets/uploads/logos/' . $GetSchoolLogo->logo)); ?>"
                                        ...
                                        <div style="
                                            ...
                                            margin-left: -30px;">
                                            Personal Profile
                                            <img src="<?php echo e(public_path('assets/reports/green-bg.jpg')); ?>" style="width:20px; position:absolute; right:-20px; top:100%;">
                                        </div>
...
<?php /**PATH C:\xampp\htdocs\nep\resources\views/reports/fitness/pdf/cbse-report.blade.php ENDPATH**/ ?>