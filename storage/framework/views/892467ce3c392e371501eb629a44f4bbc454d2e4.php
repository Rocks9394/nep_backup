...
<style>
    ...
    <audio id="whistleSound" src="<?php echo e(asset('public/assets/audio/whistle.mp3')); ?>"></audio>
...
$(document).ready(function() {
    $('#save_flamingo_record_id').submit(function(e) {
        ...
        submitLoader();
        $.ajax({
            url: '<?php echo e(route("flamingo.record.submit")); ?>', // or your route URL
            method: 'POST',
            data: $(this).serialize(),
