...
<form class="row" method="POST" name="<?php echo e($TestTypeId); ?>" id="<?php echo e($TestTypeId); ?>" action="javascript:void(0);">
    ...
    <div class="col-12">
        <div class="row form mb-4">
            <h3 class="mb-3 text-center"><?php echo e($title); ?> Score</h3>  
            <div class="input-group mb-3 text-center">
                <span class="form-control single-input">
                    <label for="pushUpCount" class="form-label">Counts</label>
                    
                    <input type="text" name="total_push_up" class="form-control form-control-lg text-center" id="pushUpCount" placeholder="00" <?php echo e($isTimerTest ? 'disabled' : ''); ?>>
                </span>
            </div>
...
<script>
const TestTypeId = parseInt(<?php echo json_encode($TestTypeId, 15, 512) ?>);
const isTimerTest = <?php echo json_encode($isTimerTest, 15, 512) ?>;
