 <table border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td
            style="border:1px solid #0A87CD; padding:3px 4px; text-align:left; width:190px;">
            <img src="<?php echo e(public_path('assets/imgs/1smiles.png')); ?>" style="height:20px;">
        </td>
        <td
            style="border:1px solid #0A87CD; padding:3px 4px; font-weight:500; color:#000; width: 17%" >
            Emerging
        </td>
...
</table><?php /**PATH C:\xampp\htdocs\nep\resources\views/reports/fitness/templates/fms-benchmark.blade.php ENDPATH**/ ?>