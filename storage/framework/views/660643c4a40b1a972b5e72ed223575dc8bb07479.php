                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 94%; border: 0; border-collapse: collapse; margin: auto;">
                                ...
                                <tr>
                                    <td style="border-bottom: 3px solid #E60A00;">
                                            ...
                                            <div style="float:left; padding: 1px 10px 3px 10px; background: #E60A00; margin-bottom: 0px;">Physical Fitness Assessment for <?php echo e($studentsData->class); ?>-<?php echo e($studentsData->section); ?></div>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; font-size: 13px; border-collapse: collapse; color:#333;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding: 0px 4px 2px 6px; font-weight: 500; color:#000; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;"><?php echo e($value['Current_Term'][0]['created_at'] ?? '---'); ?></td>
                                                                        <td style="text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;"><?php echo e($value['Current_Term'][0]['score'] ?? '---'); ?></td>
                                                                        <td style="text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;"><?php echo e($value['Current_Term'][0]['Level'] ?? '---'); ?></td>
                                                            ...
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; font-size: 13px; border-collapse: collapse; color:#333;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding: 0px 4px 2px 6px; font-weight: 500; color:#000; text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;"><?php echo e($value['Previous_Term'][0]['created_at'] ?? '---'); ?></td>
                                                                        <td style="text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;"><?php echo e($value['Previous_Term'][0]['score'] ?? ''); ?></td>
                                                                        <td style="text-align: center; border: 1px solid orange; border-bottom: 1px solid #00A923;"><?php echo e($value['Previous_Term'][0]['Level'] ?? '---'); ?></td>
                                                ...
                                                <td>
                                                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border-top: 1px solid transparent; border-left: 1px solid #00A923; border-right: 1px solid #00A923; border-bottom: 1px solid #00A923; font-size: 13px; border-collapse: collapse; color:#333;">
                                                        <tr>
                                                            ...
                                                            <td style="padding:0px 4px 2px 8px; line-height:14px; font-size:13px;"><?php echo e($value['Current_Term'][0]['recommendation'] ?? '---'); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
