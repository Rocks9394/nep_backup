<table border="0" cellpadding="0" cellspacing="0" style="width: 100%; border: 0; border-collapse: collapse;">
    ...
    <tr>
        <td style="background:#fff; text-align:center;">
            <img src="<?php echo e(asset('public/assets/reports/correct-posture.png')); ?>" alt="" style="height: 180px; width:auto;">
        </td>
    </tr>
    ...
    <tr>
        <td style="background:#fff; text-align:center;">
            <img src="<?php echo e(asset('public/assets/reports/incorrect-posture.png')); ?>" alt="" style="height: 180px; width:auto;">
        </td>
    </tr>
</table><?php /**PATH C:\xampp\htdocs\nep\resources\views/assessor/reports/templates/posture.blade.php ENDPATH**/ ?>