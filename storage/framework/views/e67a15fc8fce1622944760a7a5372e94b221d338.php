        ...
        <div class="container">
            <div class="t-mrg2">
                <div class=" all-chaptr-cards" style="margin: 0;">
                    <form method="POST" class="" name="view-trainer-report" id="" action="<?php echo e(route('student.map.students')); ?>">
                            <div class="row">
                                <div class="col">
                                ...
                                <div class="col col-md-auto">
                                    <div class="form-group select-class">
                                        ...
                                        <select class="form-control mx-0 w-100" name="by_class_id" id="by_class_id" onchange="getStudentDetail(0,this.value)">
                                            ...
                                            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($val->id. '-' . $val->class_id); ?>"><?php echo e($val->classname.'-'.$val->section); ?></option>
...
<script>
    function getStudentDetail(i, val) {
        ...
        jQuery.ajax({
            url: "<?php echo e(route('get.students.according.to.class')); ?>",
            data: {
                "class_id": val,
                "school_id": school_id,
                "_token": csrfToken
            ...
            success: function(response) {
                ...
                jQuery.ajax({
                    url: "<?php echo e(route('get.sports')); ?>",
                    type: 'GET',
                    data: {
                        "school_id": school_id,
                        "_token": csrfToken
...
<?php echo $__env->make('layouts.filldart-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/nep/resources/views/fill-darts/map-students.blade.php ENDPATH**/ ?>