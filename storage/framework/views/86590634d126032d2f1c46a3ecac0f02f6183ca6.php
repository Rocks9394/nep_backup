...
<?php $component = $__env->getContainer()->make(App\View\Components\DataListingComponent::class, ['id' => 'upload_test_data','headers' => ['Skill Name', 'Test Applicable in Classes', 'Download', 'Download'],'columns' => [
                ...
                ],'ajaxUrl' => ''.e(route('upload.test.data')).'','enableExportButtons' => false,'enableLengthMenu' => false,'exportButtonText' => 'Bulk Action','pageLength' => 100,'enableOnlyClassFilter' => false,'enableSkillNameFilter' => false,'selectedOnlyClass' => null,'enableStatusFilter' => true,'statusModeFlag' => 1,'selectedStatus' => 'incomplete','searchPlaceholder' => 'Search: Skill Name','exportButtons' => [
                    [   
