                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="heading-rw mt-0 mt-md-1 mb-0 p-0">
                                <a href="<?php echo e(route('all-test')); ?>" class="back-button">
                                    <span class="arrow">
                                    ...
                                    <?php $__currentLoopData = $testType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <div class="get_ready">
                                                ...
                                                <?php if($SeniorBMI == false): ?>
                                                    <a href="<?php echo e(route('fms-types', ['TestTypeId' => $val->TestTypeID])); ?>">
                                                        <span><?php echo e($val->TestPerformed); ?></span>
                                                        <span class="arrow-i"><i class="bi bi-arrow-right"></i></span>
                                                    </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('fms-types-senior', ['TestTypeId' => $val->TestTypeID, 'SeniorBMI' => true])); ?>">
                                                        <span><?php echo e($val->TestPerformed); ?></span>
                                                        <span class="arrow-i"><i class="bi bi-arrow-right"></i></span>
                                                    </a>
                                                <?php endif; ?>
                                            ...
                                            <a href="javascript:void(0);" class="play" data-toggle="modal" 
                                                data-target="#playModal" data-testtypeid="<?php echo e($val->TestTypeID); ?>" data-testname="<?php echo e($val->TestPerformed); ?>"> <i class="bi bi-play-circle"></i> 
                                            </a>
                                        </li>
...
<?php echo $__env->make('layouts.icsce-master-app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/nep/resources/views/assessor/locomotorSkills.blade.php ENDPATH**/ ?>