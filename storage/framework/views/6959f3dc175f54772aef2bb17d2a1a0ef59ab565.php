...
<head>
    ...
    <title>Goforfit | Reports</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,100..900;1,100..900&family=Roboto:ital,wght@0,100..900;1,100..900&display=swap" rel="stylesheet">
    <style>
        *,body {  margin: 0;   padding: 0; }
        body { font-family: "Roboto Condensed", sans-serif;  font-optical-sizing: auto; background-color: #eee; }
        page[size="A4"] { width: 21cm; height: 29.7cm; margin: 0; }
    </style>
</head>
                    ...
                    <tr>
                        <td style="border-collapse: collapse;">
                            <div style="width: 100%; position: relative; border-collapse: collapse;">
                                ...
                                <img src="<?php echo e(asset('/public/assets/reports/report-cover-j-img.png')); ?>" alt="" style="width: 76%;">
                            </div>
                        </td>
                    </tr>
                    <tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                            ...
                                                            <td colspan="2" style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px;">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;"> <?php echo e($studentsData->display_classname); ?>-<?php echo e($studentsData->section); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;"><?php echo e($studentsData->rollno ?? ''); ?> </td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            <td style="padding: 6px 0; width:55%;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        <td style="padding: 0px 0px 2px 0px;"><span style="display: inline-block; margin-right: 5px; margin-left: 5px; ">Registration&nbsp;No</span></td>
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;"><?php echo e($studentsData->admissionnumber); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;"><?php echo e($formattedDob); ?> (<?php echo e($age); ?> Years)</td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;"><?php echo e($gender); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td colspan="2" style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;"><?php echo e($studentsData->school_name); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: center; font-weight: 600; padding: 0px 0px 4px 0px;"><?php echo e($studentsData->school_code); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td style="padding: 6px 0;">
                                                                <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0px">
                                                                    <tr>
                                                                        ...
                                                                        <td style="border-bottom: 1px solid #ccc; width: 100%; text-align: left; font-weight: 600; padding: 0px 0px 4px 0px;"><?php echo e($studentsData->apaarId ?? ''); ?></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                    ...
                    <tr>
                        <td>
                            <table cellpadding="0" cellspacing="0" style="width: 94%; border: 0; border-collapse: collapse; margin: auto;">
                                <tr>
                                    <td style="border-bottom: 3px solid #E60A00;">
                                         <div style="background:#E60A00; float:left; display: inline-flex; align-items: center; color: #fff; font-size: 18px; font-weight: 600; height: 32px;">
                                            <div style="float: left; padding: 1px 0px 0px 10px; margin-bottom: -3px;">
                                                Physical Fitness Assessment for <?php echo e($studentsData->display_classname); ?>-<?php echo e($studentsData->section); ?></div>
                                ...
                                <tr>
                                    <td style="padding: 6px 10px 6px 0px; font-size: 18px; color:#000; font-size: 16px; font-weight: 600;"><?php echo e($displayKey); ?></td>
                                </tr>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; font-size: 13px; border-collapse: collapse; color:#333;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding: 4px 0px 4px 0px; font-weight: 500; color:#000; text-align: center;"><?php echo e($value['Current_Term'][0]['created_at'] ?? '---'); ?></td>
                                                                        ...
                                                                        <td style="padding: 0px 4px 2px 6px; text-align: center; border: 1px solid orange;"><?php echo e($value['Current_Term'][0]['Level'] ?? '---'); ?></td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; border-bottom: 1px solid #00A923; font-size: 14px; border-collapse: collapse; color:#333;">
                                                                    ...
                                                                    <tr>                
                                                                        ...
                                                                        <td style="padding: 4px 4px 4px 6px; text-align: center;"><?php echo e($currentScore ?? '---'); ?></td>
                                                                        <td style="padding: 4px 4px 4px 6px; text-align: center;"><?php echo e($currentLevel ?? '---'); ?></td>
                                                            ...
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; border-bottom: 1px solid #00A923; font-size: 14px; border-collapse: collapse; color:#333;">
                                                                    ...
                                                                    <tr>
                                                                        <td style="padding: 4px 4px 4px 6px; font-weight: 500; color:#000; text-align: center;"><?php echo e($value['Previous_Term'][0]['created_at'] ?? '---'); ?></td>
                                                                        <td style="padding: 4px 4px 4px 6px; text-align: center;"><?php echo e($previousScore ?? '---'); ?></td>
                                                                        <td style="padding: 4px 4px 4px 6px; text-align: center;"><?php echo e($previousLevel ?? '---'); ?></td>
                                            ...
                                            <tr>
                                                <td>
                                                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border-top: 1px solid transparent; border-left: 1px solid #00A923; border-right: 1px solid #00A923; border-bottom: 1px solid #00A923; font-size: 14px; border-collapse: collapse; color:#333;">
                                                        <tr>
                                                            <td style="border-top: 1px solid #00A923; background-color: #00A923; padding: 3px 4px; padding: 5px 10px; color: #fff; text-align: center; width: 100px; font-weight: bold;">Recommendation</td>
                                                            <td style="padding: 3px 4px;"><?php echo e($value['Current_Term'][0]['recommendation'] ?? '---'); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                ...
                                <tr>
                                    <td>
                                        <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #0A87CD; font-size: 14px; border-collapse: collapse; color:#000; text-align:center;">
                                            <tr style="background-color: #0A87CD;">
                                                <td style="padding: 5px 10px; font-weight: bold; color:#fff; font-size: 16px;" colspan="8">Fitness Benchmarks for <?php echo e($age); ?> years <?php echo e($gender); ?></td>
                                            </tr>
                                            <tr style="font-weight: bold; background-color: #fecd0a; font-size: 12px; color: #000;">
                                                <td style="padding: 5px;"></td>
                                                <td style="padding: 5px;">L1 (Very Low)</td>
                                                <td style="padding: 5px;">L2 (Low)</td>
                                                <td style="padding: 5px;">L3 (Developing)</td>
                                                <td style="padding: 5px;">L4 (Moderate)</td>
                                                <td style="padding: 5px;">L5 (Good)</td>
                                                <td style="padding: 5px;">L6 (High)</td>
                                                <td style="padding: 5px;">L7 (Excellent)</td>
                                            </tr>
                                            <tr style="background-color: #fff6d1; font-weight: 500; color:#000;">
                                                <td style="padding: 5px;"></td>
                                                <td style="padding: 5px;">< 20 %ile</td>
                                                <td style="padding: 5px;">≥ 20 %ile</td>
                                                <td style="padding: 5px;">≥ 40 %ile</td>
                                                <td style="padding: 5px;">≥ 60 %ile</td>
                                                <td style="padding: 5px;">≥ 70 %ile</td>
                                                <td style="padding: 5px;">≥ 80 %ile</td>
                                                <td style="padding: 5px;">≥ 90 %ile</td>
                                            </tr>
                                          
                                            <?php $__currentLoopData = $getFitnessBenchmark; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $skillname): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td style="padding: 3px 4px; font-weight: bold; color: #000; text-align:left;"><?php echo e($skillname->skill_name); ?></td>
                                                <?php $__currentLoopData = $skillname->ranges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level => $range): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <td style="padding: 3px 4px;"><?php echo e($range); ?></td>  
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </table>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0" style="width: 94%; border: 0; border-collapse: collapse; margin: auto;">
                                <tr>
                                    <td style="border-bottom: 3px solid #E60A00;">
                                        <div style="background:#E60A00; float:left; display: inline-flex; align-items: center; color: #fff; font-size: 18px; font-weight: 600; height: 32px;">
                                            <div style="float: left; padding: 1px 0px 0px 10px; margin-bottom: -3px;">Developmental Skills for <?php echo e($studentsData->class); ?>-<?php echo e($studentsData->section); ?></div>
                                            <div style="float:left; transform: skew(26deg,0deg); display:inline-block; width: 20px; height: 32px; background: #E60A00; position: relative; right: -10px;"></div>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding: 5px 10px; font-size: 20px; background:#0A87CD; color:#fff; font-size: 16px; font-weight: 600;"><?php echo e($key); ?></td>
                                </tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0; border-collapse: collapse;">
                                            <tr>
                                                <td style="vertical-align: top;">
                                                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; font-size: 13px; border-collapse: collapse; color:#333;">
                                                        <tr style="background-color: #fecd0a;">
                                                            <td style="font-weight: 500; width: 27%; background-color:#fecd0a; padding: 3px 4px 3px 6px; border: 1px solid orange; color:#000;" rowspan="2">Skills</td>
                                                            <td style="font-weight: 500; width: 12%; padding: 3px 4px 3px 6px; border: 1px solid orange; color:#000; text-align: center; font-weight: bold;">Current Term</td>
                                                            <td style="font-weight: 500; width: 14%; padding: 3px 4px 3px 6px; border: 1px solid orange; color:#000; text-align: center; font-weight: bold;">Previous Term</td>
                                                            <td style="font-weight: 500; padding: 3px 4px 3px 6px; border: 1px solid orange; color:#000;" rowspan="2">Recommendation</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="font-weight: 500; background-color:#ffe167; padding: 3px 4px 3px 6px; border: 1px solid orange; color:#000; text-align: center;">Outcome</td>
                                                            <td style="font-weight: 500; background-color: #ffe167; padding: 3px 4px 3px 6px; border: 1px solid orange; color:#000; text-align: center;">Outcome</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 3px 4px 3px 6px; font-weight: 500; color:#000;"><?php echo e($data['Test_Name'] ?? ''); ?></td>
                                                            ...
                                                            <td style="padding: 3px 4px 3px 6px; font-size: 12px;"><?php echo e($data['recommendation'] ?? ''); ?></td>
                                ...
                                <tr>
                                    <td style="padding: 5px 10px; font-size: 20px; background:#0A87CD; color:#fff; font-size: 16px; font-weight: 600;">Developmental Stages for <?php echo e($age); ?> Years <?php echo e($gender); ?></td>
                                </tr>
                                            ...
                                            <tr>
                                                <td style="vertical-align: top;">
                                                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid #0A87CD; font-size: 13px; border-collapse: collapse; color:#333;">
                                                        <tr>
                                                            <td style="padding: 3px 4px; text-align:left; width:110px;"><img src="<?php echo e(asset('public/assets/imgs/1smiles.png')); ?>" alt="" style="height: 20px;"></td>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 3px 4px; text-align:left;"><img src="<?php echo e(asset('public/assets/imgs/3smiles.png')); ?>" alt="" style="height: 20px;"></td>
                                                        ...
                                                        <tr>
                                                            <td style="padding: 3px 4px; text-align:left;"><img src="<?php echo e(asset('public/assets/imgs/4smiles.png')); ?>" alt="" style="height: 20px;"></td>
                                ...
                                <tr>
                                    <td style="vertical-align:top;">                                      
                                        ...
                                        <?php switch($studentsData->class_id):
                                            case (18): ?>
                                                <?php echo $__env->make('assessor.reports.templates.posture', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php break; ?>
                                            <?php case (14): ?>
                                                <?php echo $__env->make('assessor.reports.templates.olympics-paralympics', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php break; ?>
                                            <?php case (22): ?>
                                                <?php echo $__env->make('assessor.reports.templates.daily-routine-table', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                <?php break; ?>
                                        <?php endswitch; ?>                                        
                                    </td>
                                </tr>                              
                                   ...
                                   <td style="position: relative; vertical-align: top; width: 360px; height: 100%; " >                               
                                    ...
                                    <!-- <td style="width:300px;">
                                        <div style="margin-left: 30px; margin-top: 30px; float:left;">
                                            <img src="<?php echo e(asset('/public/assets/reports/school-logo.png')); ?>" alt="" style="height:50px;">
                                        </div>
                                    </td> -->
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 94%; border: 0; border-collapse: collapse; margin: auto; color: #333; font-size: 12px;">
                                <tr>
                                    <td style="border: 1px solid #00A923; padding: 10px 15px 8px 15px; background:#F2FFF5;">
                                        ...
                                        <h4 style="color: #000; margin-bottom: 5px; font-size: 16px">Age Appropriate Fitness Protocols and Guidelines for age 3-18</h4>
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0; border-collapse: collapse;">
                                            <tr>
                                                <td colspan="2">
                                                    <h3 style="color: #000; font-size: 16px; margin-bottom: 10px;">Recommends the following activities for improving fitness for ages 5-8 years</h3>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <h4 style="color: #000; margin-bottom: 5px; font-size: 14px;">1. Hand-Eye Coordination Activities</h4>
                                                    <p>Ball Toss Against Wall, Juggling with Scarves or Balls, Target Throws, Table Tennis / Bat & Ball, Clap-Catch Game, Reaction Ball Drill</p>
                                                </td>
                                                <td>
                                                    <h4 style="color: #000; margin-bottom: 5px; font-size: 14px;">2. One-Leg Balance Activities</h4>
                                                    <p>Single-Leg Stance, Balance with Arm Movements, Reach-and-Touch, Leg Swings, Tree Pose (Yoga), Balance Pad / Cushion Stance</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
</html><?php /**PATH C:\xampp\htdocs\nep\resources\views/reports/fitness/html/junior-report.blade.php ENDPATH**/ ?>