                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0" style="width: 94%; border: 0; border-collapse: collapse; margin: auto;">
                                ...
                                <?php
                                    ...
                                    $score = $value[0]['score'] ?? null;
                                    $level = $value[0]['Level'] ?? '---';

                                    if ($key === 'Static Balance (Flamingo Balance Test)' && $score == '1000 times') {
                                        $score = '> 15 times (30s)';
                                        $level = 'Disqualified';
                                    }

                                    if ($key === 'Static Balance (Flamingo Balance Test)' && $score == '500 times') {
                                        $score = '> 26 times (60s)';
                                        $level = 'Disqualified';
                                    }
                                                            ...
                                                            <td style="width: 50%;">
                                                                <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; border-bottom: 1px solid #00A923; font-size: 14px; border-collapse: collapse; color:#333;">
                                                                    ...
                                                                    <tr>                
                                                                        ...
                                                                        <td style="padding: 4px 4px 4px 6px; text-align: center;"><?php echo e($score ?? '---'); ?></td>
                                                                        <td style="padding: 4px 4px 4px 6px; text-align: center;"><?php echo e($level ?? '---'); ?></td>
                                                ...
                                                <td>
                                                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border-top: 1px solid transparent; border-left: 1px solid #00A923; border-right: 1px solid #00A923; border-bottom: 1px solid #00A923; font-size: 14px; border-collapse: collapse; color:#333;">
                                                        <tr>
                                                            ...
                                                            <td style="padding: 3px 4px;"><?php echo e($value[0]['recommendation'] ?? '---'); ?></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 100%; border: 0; border-collapse: collapse;">
                                            <tr>
                                                <td style="vertical-align: top;">
                                                    <table border="1" cellpadding="0" cellspacing="0" style="width: 100%; border: 1px solid orange; font-size: 13px; border-collapse: collapse; color:#333;">
                                                        <tr style="background-color: #fecd0a;">
                                                            <td style="font-weight: 500; width: 30%; background-color:#fecd0a; padding: 3px 4px 3px 6px; border: 1px solid orange; color:#000;" rowspan="2">Skills</td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 3px 4px 3px 6px; text-align: center;">
                                                                <img src="<?php echo e(asset('public/assets/imgs/' . $data['count'] . 'smiles.png')); ?>" style="height: 20px;">                                                               
                                                            </td>
                                                            <?php else: ?>
                                                            <td style="padding: 3px 4px 3px 6px; text-align: center;" data-id="<?php echo e($data['count']); ?>">NA     
                                                            </td>
                                                            <?php endif; ?>
                                                            <td style="padding: 3px 4px 3px 6px;"></td>
