            ...
            <div class="row">
                <div class="col-12">
                    <div class="action-bar py-3 p-0 actions">
                        <button type="reset" id="reset_<?php echo e($id); ?>" class="btn py-2 px-5 btn btn-outline-secondary">Reset</button>	
                        <button type="submit" id="submit_<?php echo e($id); ?>" class="btn py-2 px-5 btn-primary">Save</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    let resetBtn = document.getElementById("reset_<?php echo e($id); ?>");
...
</script><?php /**PATH /var/www/nep/resources/views/components/reset-submit-btn.blade.php ENDPATH**/ ?>